                        ...
                        <div class="modal-body" style="padding:0px 5px !important">
                            ...
                            <div class="table-Trans_List tableFixHead">
                                <table class="tree table table-striped table-bordered table-Trans_List tableFixHead" id="table_Trans_List" width="100%">
                                    <thead>
                                        <tr style="display:none;">
                                            <td colspan="9" ><h5 style="text-align:center;"><span style="font-size:15px;font-weight:700;"><?php echo $company_detail->company_name; ?></span><br><span style="font-size:10px;font-weight:600;"><?php echo $company_detail->address; ?></span><br><span class="" style="font-size:10px;">Transfer Master</span><br><span class="report_for" style="font-size:10px;"></span></h5></td>
                                        </tr>
                                        <tr>
                                            <th id="sl" style="text-align:left;">TransID <span class="up_starting">  &#8593;</span><span class="down" style="display:none;"> &#8593;</span><span class="up" style="display:none;"> &#8595;</span></th>
                  ...
                  success:function(data){
                    if(empty(data)){
                        ...
                        for (var index = 0; index < ItemDetails.length; index++) {
                            var Cases = parseFloat(ItemDetails[index].BilledQty) / parseFloat(ItemDetails[index].CaseQty);
                            ...
                            html += "<td id='qty"+countof_record+"'><input type='text' style='text-align:center;width: 80px;' name='qty_val"+countof_record+"' id='qty_val"+countof_record+"' value='"+Cases+"' onchange='myFunction("+countof_record+")'></td>";
