...
<div id="wrapper">
  <div class="content">
    ...
    render_datatable($table_data,'recipe-table'); ?>
  </div>
</div>
</div>
</div>
...
<script>
  $(function(){
    ...
    initDataTable('.table-recipe-table', admin_url+'production/table', notSortableAndSearchableItemColumns, notSortableAndSearchableItemColumns,'undefined',[0,'desc']);
