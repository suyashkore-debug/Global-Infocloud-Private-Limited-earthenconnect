            ...
            ?>
                ...
                <div class="col-md-3">
                    <div class="form-group" app-field-wrapper="status_list">
                       ...
                       <select name="status_list" id="status_list" class="selectpicker" data-width="100%" data-none-selected-text="Non selected" data-live-search="true">
                           <option value="pending">Pending</option>
                           <option value="WELDING">WELDING</option>
                           <option value="ASSEMBLY">ASSEMBLY</option>
                           <option value="PAINTING">PAINTING</option>
                           <option value="MOVEMENT FOR GODOWN">MOVEMENT FOR GODOWN</option>
              ...
              <table class="tree table table-striped table-bordered table-daily_report tableFixHead2" id="table-daily_report" width="100%">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th style="text-align:left;">STD FGQty</th>
                    <th style="text-align:left;">Actual Qty</th>
                    <th style="text-align:left;">Diff. Qty</th><!--
                    <th style="text-align:left;">ReqTM</th>
                    <th style="text-align:left;">PRDTM</th>-->
                    <th style="text-align:left;">Production Manager</th>
