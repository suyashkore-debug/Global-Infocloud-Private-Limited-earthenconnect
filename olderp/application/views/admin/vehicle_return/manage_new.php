        ...
        <div class="panel-body">
            ...
            <div class="tab-content">
                ...
                <div class="row">
                            ...
                            <?php
                               ...
                               $_vehicle_return_number = str_pad($new_vehicle_returnNumber, get_option('number_padding_prefixes'), '0', STR_PAD_LEFT);
                                ...
                                <span class="input-group-addon">
                                              ...
                                              <input type="hidden" name="row_count" value=" " id="row_count">
                                               <input type="hidden" name="row_count_frRtn" value="" id="row_count_frRtn">
                                              <input type="hidden" name="row_count_pay" value=" " id="row_count_pay">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                           <input type="text" readonly="" placeholder="CaseDeposit" class="form-control" name="case_depo1" id="case_depo1"  aria-invalid="false">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                           <input type="text" readonly="" class="form-control" name="check_depo" id="check_depo" placeholder="CheckDeposit" aria-invalid="false">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                           <input type="text"  class="form-control" placeholder="FreshReturn Amt" name="fresh_ret_amt1" id="fresh_ret_amt1"  aria-invalid="false">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                           <input type="text" readonly="" class="form-control" name="total_expense1" id="total_expense1" placeholder="TotalExpenses" aria-invalid="false">
