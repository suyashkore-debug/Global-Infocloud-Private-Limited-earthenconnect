            ...
            <div class="tab-content">
                ...
                <div class="row">
                            ...
                            <?php
                               ...
                               $_vehicle_return_number = str_pad($__number, get_option('number_padding_prefixes'), '0', STR_PAD_LEFT);
                                ...
                                <span class="input-group-addon">
                                              ...
                                              <input type="text" readonly name="vehicle_return_id" id="vehicle_return_id" class="form-control vehicle_return_id" value="<?php if(isset($sale_return)){ echo substr($sale_return->SalesRtnID,5);}else{ echo $_vehicle_return_number; } ?>" <?php if(isset($sale_return)){ echo "disabled";} ?>>
                                            <?php if(isset($return_list)){
                                                ?>
                                            <input type="hidden" name="updated_record" value="<?= $return_list['ReturnID'];?>" id="updated_record">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                           ...
                           <div class="form-group ">
                                        ...
                                        <input type="text" readonly name="challan_n" placeholder="Challan No" id="challan_n" class="form-control "  value="<?= $return_list['ChallanID'];?>">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" readonly="" class="form-control" placeholder="Route code" value="<?= $return_list['RouteID'];?>" name="route_code" id="route_code"  aria-invalid="false">
                            </div>
                        </div>
                        <div class="col-md-3 ">
                            <div class="form-group">
                                <input type="text" readonly="" class="form-control" name="route_name" id="route_name" value="<?= $return_list['name'];?>" aria-invalid="false">
                            </div>
                        </div>
                        <div class="col-md-2 ">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                         <div class="form-group">
                                <input type="text" readonly="" class="form-control"  value="<?= $return_list['VehicleID'];?>" name="vehicle_number" id="vehicle_number" placeholder="vehicle" aria-invalid="false">
                            </div>
                    </div>
                    <div class="col-md-3 ">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <input type="text" readonly="" placeholder="Vehi.Capacity" value="<?= $return_list['VehicleCapacity'];?>" class="form-control" name="vehicle_capc" id="vehicle_capc"  aria-invalid="false">
                         </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                           <input type="text"  placeholder="CaseDeposit" class="form-control" value="" name="case_depo" id="case_depo"  aria-invalid="false">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <input type="text" readonly="" class="form-control" value="<?= $return_list['DriverID'];?>" placeholder="Driver" name="driver_id" id="driver_id"  aria-invalid="false">
                    </div>
                    <div class="col-md-3 ">
                        <div class="form-group">
                            <!--<label for="estimate"></label>-->
                            <input type="text" readonly="" class="form-control" value="<?= $return_list['driver_fn'].' '.$return_list['driver_ln'];?>" name="driver_name" id="driver_name"  aria-invalid="false">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                           <input type="text" readonly="" class="form-control" value="<?= $return_list['Crates'];?>" placeholder="ChallanCrates" name="challan_crates" id="challan_crates"  aria-invalid="false">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <input type="text" readonly="" class="form-control" value="<?= $return_list['LoaderID'];?>" placeholder="Loder" name="loder_id" id="loder_id"  aria-invalid="false">
                    </div>
                    <div class="col-md-3 ">
                        <div class="form-group">
                            <!--<label for="estimate"></label>-->
                            <input type="text" readonly="" class="form-control" value="<?= $return_list['loader_fn'].' '.$return_list['loader_ln'];?>" name="loder_name" id="loder_name"  aria-invalid="false">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                           <input type="text" readonly="" class="form-control" value="<?= $return_list['return_crates'];?>" placeholder="RefundCrates" name="refund_crates" id="refund_crates"  aria-invalid="false">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <input type="text" readonly="" class="form-control" value="<?= $return_list['SalesmanID'];?>" placeholder="Sales Man" name="salesman_id" id="salesman_id"  aria-invalid="false">
                    </div>
                    <div class="col-md-3 ">
                        <div class="form-group">
                            <!--<label for="estimate"></label>-->
                            <input type="text" readonly="" class="form-control" value="<?= $return_list['Salesman_fn'].' '.$return_list['Salesman_fn'];?>" name="salesman_name" id="salesman_name"  aria-invalid="false">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                           <input type="text"  class="form-control" value="<?= $expense_amount;?>" name="total_expense" id="total_expense" placeholder="TotalExpenses" aria-invalid="false">
                        </div>
                    </div>
                </div>
            </div>
...
<?php $this->load->view('admin/vehicle_return/vehicle_return_edit_js'); ?>
