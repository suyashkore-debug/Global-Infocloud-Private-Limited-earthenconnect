   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title">CDNotes List</h4>
         </div>
            ...
            <div class="table_cd_report">
              ...
              <table class="tree table table-striped table-bordered table_cd_report" id="table_cd_report" width="100%">
                ...
                <thead>
                    ...
                    <tr>
                             <th style="width:10%;">CR-DR No</th>
                             <th style="width:10%;text-align:left;">CR-DR Type</th>
                             <th style="width:10%;text-align:left;">TrandDate</th>
                             <th style="width:28%;text-align:left;">Account Name</th>
                             <th style="width:5%;text-align:left;">state</th>
                             <th style="width:3%;text-align:left;">GrossAmt</th>
                             <th style="width:3%;text-align:left;">CGSTAmt</th>
                             <th style="width:3%;text-align:left;">SGSTAmt</th>
                             <th style="width:3%;text-align:left;">IGSTAmt</th>
                             <th style="width:3%;text-align:left;">NetAmt</th>
                          </tr>
                </thead>
                <tbody>
                </tbody>
