         ...
         <tr data-name="<?php echo $feature; ?>">
            ...
            <td>
               ...
               <?php foreach ($permission['capabilities'] as $capability => $name) {
                  ...
                  $checked = ' checked ';
                  if($member->permissions[$i]["days"] !== "0"){
                      $number = $member->permissions[$i]["days"];
                  }else{
                    $number = '';  
                  }
            ...
            <td>
               ...
               <?php } ?>
               <td>
               <input type="text" name="<?php echo $feature; ?>" id="number_day" class="form-control" value="<?php echo $number; ?>" style="width: 40px;">
                </td>
         </tr>
         <?php
