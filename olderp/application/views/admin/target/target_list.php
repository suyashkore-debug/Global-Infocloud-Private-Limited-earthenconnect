...
<div id="wrapper">
  <div class="content">
    <div class="row">
     ...
     <div class="col-md-2">
     <div class="_buttons">
	    <a href="<?php echo admin_url('target/manage'); ?>" class="btn btn-info pull-left display-block"><?php echo _l('new_Target'); ?></a>  
	 </div>
	 </div>
       <div class="_buttons">
        <h4>Target List</h4>
    ...
    render_datatable($table_data,'target-table'); ?>
  </div>
</div>
</div>
</div>
...
<script>
  $(function(){
    ...
    initDataTable('.table-target-table', admin_url+'target/table', notSortableAndSearchableItemColumns, notSortableAndSearchableItemColumns,'undefined',[0,'desc']);
