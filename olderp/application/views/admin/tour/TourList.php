               ...
               <div class="panel-body">
                    ...
                    <div class="row">
                       <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                         <?php echo render_select('distributor_state',$state,array('short_name','state_name'),'state'); ?>
                        </div>
                        <div class="col-md-2">
              ...
              <table class="tree table table-striped table-bordered table-daily_report tableFixHead2" id="table-daily_report" width="100%">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th style="text-align:left;width:15%">Staff Name</th>
                    <th style="text-align:left;width:10%">Purpose</th>
                    <th style="text-align:left;width:8%">Start Date</th>
                    <th style="text-align:left;width:8%">End Date</th>
                    <th style="text-align:left;width:5%">State</th>
                    <th style="text-align:left;width:8%">City</th>
                    <th style="text-align:left;width:15%">Area</th>
                    <th style="text-align:left;width:21%">Remark</th>
...
$(document).ready(function(){
  ...
  function load_data(from_date,to_date,state,resPerson)
  {
    $.ajax({
        url:"<?php echo admin_url(); ?>tour/GetTourPlan",
        dataType:"html",
        method:"POST",
        data:{from_date:from_date, to_date:to_date,state,resPerson},
        beforeSend: function () {
 ...
 $('#search_data').on('click',function(){
	    ...
	    var msg = "Filter "+from_date +" To " + to_date+", state: "+distributor_state;
	    
	    $(".report_for").text(msg);
        load_data(from_date,to_date,distributor_state,responsible_admin);
 });
