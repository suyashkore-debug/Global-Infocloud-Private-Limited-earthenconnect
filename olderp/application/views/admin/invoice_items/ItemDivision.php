                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group" app-field-wrapper="ItemDivisionID">
                            <label for="ItemDivisionID" class="control-label">ItemDivisionID</label>
                    ...
                    <div class="col-md-4">
                        <?php echo render_input('ItemDivisionName','ItemDivision Name'); ?>
                    </div>
                ...
                <div class="modal fade ItemDivision_List" id="ItemDivision_List" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
                    <div class="modal-dialog modal-md" role="document">
                        ...
                        <div class="modal-header" style="padding:5px 10px;">
                            ...
                            <h4 class="modal-title">ItemDivision List</h4>
                        </div>
                            ...
                            <div class="table-ItemDivision_List tableFixHead2">
                                <table class="tree table table-striped table-bordered table-ItemDivision_List tableFixHead2" id="table_ItemDivision_List" width="100%">
                                    <thead>
                                        ...
                                        <tr>
                                            <th id="sl" style="text-align:left;">ItemDivision ID <span class="up_starting">  &#8593;</span><span class="down" style="display:none;"> &#8593;</span><span class="up" style="display:none;"> &#8595;</span></th>
                                            <th style="text-align:left;">ItemDivision Name</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php
...
<script>
    ...
    // On Blur ItemID Get All Date
        $('#ItemDivisionID').blur(function(){ 
            ...
            if(ItemDivisionID == ''){
                ...
                $.ajax({
                url:"<?php echo admin_url(); ?>invoice_items/GetItemDivisionDetailByID",
                dataType:"JSON",
                method:"POST",
    ...
    // Save New ItemDivision
        $('.saveBtn').on('click',function(){ 
            ...
            $.ajax({
                url:"<?php echo admin_url(); ?>invoice_items/SaveItemDivision",
                dataType:"JSON",
                method:"POST",
                data:{ItemDivisionID:ItemDivisionID,ItemDivisionName:ItemDivisionName
                },
                beforeSend: function () {
    ...
    // Update Exiting Item Division
        $('.updateBtn').on('click',function(){ 
            ...
            $.ajax({
                url:"<?php echo admin_url(); ?>invoice_items/UpdateItemDivision",
                dataType:"JSON",
                method:"POST",
                data:{ItemDivisionID:ItemDivisionID,ItemDivisionName:ItemDivisionName
                },
