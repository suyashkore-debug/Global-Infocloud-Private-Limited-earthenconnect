...
/*function load_commulatives_data(from_date,to_date,report_in,states,client_type,item_group,loc_type)
 ...
 $('#search_data').on('click',function(){
	    ...
	    if(item_group == "" || item_group== null){
          ...
          cache: false,
          data:{from_date:from_date, to_date:to_date, report_in:report_in, states:states, client_type:client_type, item_group:item_group, loc_type:loc_type, 
          report_type:report_type,staff_designation:staff_designation,staff_id:staff_id,values_in:values_in},
          beforeSend: function () {
            $('#searchh').css('display','block');
            $('.load_data').css('display','none');
         },
 ...
 $("#caexcel").click(function(){
	    ...
	    $.ajax({
            ...
            loc_type:loc_type, report_type:report_type,staff_designation:staff_designation,staff_id:staff_id,values_in:values_in},
            beforeSend: function () {
