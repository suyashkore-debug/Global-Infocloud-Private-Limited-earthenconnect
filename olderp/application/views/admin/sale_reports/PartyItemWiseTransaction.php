        ...
        <div class="panel_s">
          <div class="panel-body">
            <div class="_buttons">
                ...
                <div class="row">
                    <div class="col-md-1">
                        <label for="from_date" class="control-label">TransType</label>
                    </div>
                    <div class="col-md-2" style="padding-left: 5px;">
                        <div class="form-group">
...
<script type="text/javascript">
 function printPage(){
    ...
    heading_data += '<tr><td style="text-align:left;"colspan="'+colspan+'">'+OtherDetails+'</td></tr>';
    heading_data += '<tr><td style="text-align:left;"colspan="'+colspan+'">'+TransType+'</td></tr>';
