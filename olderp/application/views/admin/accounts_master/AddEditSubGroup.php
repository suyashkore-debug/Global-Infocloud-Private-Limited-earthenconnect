                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="subgroup_code">Account SubGroupID</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="main_group">Account MainGroup</label>
...
$(document).ready(function(){
    ...
    $("#subgroup_code").dblclick(function(){
        ...
        $('#AccountSubgroup').on('shown.bs.modal', function () {
            $('#myInput1').val('');
            $('#myInput1').focus();
            var account_subgroupID = "";
            $.ajax({
                  url:"<?php echo admin_url(); ?>accounts_master/AccountSubgroupListPopUp",
                  //dataType:"JSON",
                  method:"POST",
                  cache: false,
    ...
    $('#subgroup_code').on('focus',function(){
        ...
        $.ajax({
            ...
            success:function(data){
                $('select[name=main_group]').val('50000');
                $('.selectpicker').selectpicker('refresh'); 
