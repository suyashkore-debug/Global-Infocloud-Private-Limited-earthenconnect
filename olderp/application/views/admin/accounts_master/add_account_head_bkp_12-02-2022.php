      ...
      <div class="col-md-12">
        <div class="panel_s">
          <div class="panel-body">
                <div class="row">
                  <div class="col-md-12">
                  <h4 class="no-margin font-bold">Add New Accounts Head</h4>
                  </div>
                  </div>
                  <?php 
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <label for="opening_bal" class="control-label">Opening Bal.</label>
                            <input type="text" maxlength="12"  name="opening_bal" pattern="[0-9]" id="opening_bal" class="form-control" value="<?php echo $opening_bal->BAL1; ?>" <?php if((isset($account_detail) && is_admin()) || is_admin()){ }else{ echo "disabled"; }?>>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <?php echo render_date_input('start_date','Start Date',$new_val,$date_attrs); ?>
                    </div>
                </div>
                <!--<div class="row">
                    ...
                    <div class="col-md-3">
                        <?php echo render_input('station_name','Station Name'); ?>
                    </div>
                    <div class="col-md-3">
                        <?php //echo render_input('pan','PAN'); ?>
                        <label for="pan_number" class="control-label">PAN number</label>
                            <input type="text" maxlength="10"  name="pan_number" pattern="[0-9 A-Z] {10}" id="pan_number" class="form-control" value="<?php echo $pan_number?>">
                            <span class="pan_denger" style="color:red;"></span>
                    </div>
                    <div class="col-md-3">
                        <?php //echo render_input('aadhaar','Aadhaar'); ?>
                        <label for="aadhaar" class="control-label">Aadhar number</label>
                            <input type="text" maxlength="12"  name="aadhaar" pattern="[0-9] {10}" id="aadhaar" class="form-control" value="<?php echo $aadhar_number?>">
