...
//=================== Vendor API ===============================================
$route['VendorLOGIN'] = 'UserApp_Controller/VendorLOGINAPI';
$route['Vendorlogout'] = 'UserApp_Controller/VendorlogoutAPI';
$route['AddEditLand'] = 'UserApp_Controller/AddEditLandAPI';
$route['GetMyLand'] = 'UserApp_Controller/GetMyLandAPI';
$route['LandUnit'] = 'UserApp_Controller/LandUnitAPI';
$route['SoilType'] = 'UserApp_Controller/SoilTypeAPI';
$route['WaterQuality'] = 'UserApp_Controller/WaterQualityAPI';
$route['IrrigationResources'] = 'UserApp_Controller/IrrigationResourcesAPI';
$route['AddEditCrop'] = 'UserApp_Controller/AddEditCropAPI';
$route['ListOfCrop'] = 'UserApp_Controller/ListOfCropAPI';
$route['GetCropCategory'] = 'UserApp_Controller/GetCropCategoryAPI';
$route['GetCropMaster'] = 'UserApp_Controller/GetCropMasterAPI';

$route['LOGIN'] = 'UserApp_Controller/loginAPI';
$route['In_Out'] = 'UserApp_Controller/In_OutAPI_new';
...
/* New API*/
$route['In_Out_new'] = 'UserApp_Controller/In_OutAPI_new';
$route['In_Out_newl'] = 'UserApp_Controller/In_OutAPI_newl';
$route['In_Out_new1'] = 'UserApp_Controller/In_OutAPI_new1';
...
$route['Get_StateAPI'] = 'UserApp_Controller/Get_StateAPI';
...
$route['Dashboard'] = 'UserApp_Controller/Dashboard';
...
$route['GetSaleReport'] = 'UserApp_Controller/GetSaleReportAPI'; 
$route['GetSaleDetail'] = 'UserApp_Controller/GetSaleDetailAPI'; 
$route['CheckAccountID'] = 'UserApp_Controller/CheckAccountCodeAPI'; 
$route['SaveParty'] = 'UserApp_Controller/SavePartyAPI'; 

/* End New1 API */
/* For ISR admin */

$route['Customer_list'] = 'admin/clients/get_customer_list';
