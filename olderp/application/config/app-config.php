...
*
*/
define('APP_BASE_URL', 'https://erp.earthenconnect.ca/');
...
*/
define('APP_ENC_KEY', '6add18411b5023274353f9b9dc09086d');
 ...
 */
define('APP_DB_USERNAME', 'erp349enct1_ERP_db_usr');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'RV2%-N&~cS@O');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'erp349enct1_ec_ERP_db');
...
define('APP_DATABASE_BACKUP_MANAGER', 'backup_manager');