...
function app_init_admin_sidebar_menu_items()
{
   ...
   /* $CI->app_menu->add_sidebar_menu_item('dashboard', [
    ...
    if (has_permission_new('account_groups', '', 'view') || has_permission_new('account_groups', '', 'create') || has_permission_new('account_groups', '', 'edit') || has_permission_new('account_groups', '', 'delete')) {
        $CI->app_menu->add_sidebar_children_item('master', [
                'slug'     => 'account-groups',
                'name'     => 'Account Groups',
                'href'     => admin_url('accounts_master/ActGroup'),
                'position' => 1,
        ]);
    }
    if (has_permission_new('account_subgroups', '', 'view')) {
        $CI->app_menu->add_sidebar_children_item('master', [
                'slug'     => 'account-subgroups',
                'name'     => 'Account SubGroups',
                'href'     => admin_url('accounts_master/SubGroup'),
                'position' => 2,
        ]);
    }
    ...
    if (has_permission_new('account_head', '', 'view')) {
        $CI->app_menu->add_sidebar_children_item('master', [
                ...
                'name'     => 'Accounts Head',
                'href'     => admin_url('accounts_master/AddEditAccountHead'),
                'position' => 4,
        ]);
    }
    ...
    */
    ...
    if (has_permission_new('GodownMaster', '', 'view')) {
		...
		if (has_permission_new('leads', '', 'view')) {
		...
		if (has_permission_new('leads_source', '', 'view')) {
			$CI->app_menu->add_sidebar_children_item('leads', [
			'slug'     => 'leads-sources',
			'name'     => 'Lead Source',
		...
		if (has_permission_new('leads_reports', '', 'view')) {
		$CI->app_menu->add_sidebar_children_item('leads', [
		'slug'     => 'leads-reports',
		'name'     => 'Lead Reports',
  ...
  /*if (has_permission_new('production', '', 'view')) {
    ...
    if (has_permission_new('recipe', '', 'create') || has_permission_new('recipe', '', 'view')) {
        $CI->app_menu->add_sidebar_children_item('production', [
                ...
                'href'     => admin_url('production/BillOfMaterial'),
                'position' => 1,
        ]);
    } 
    ...
    if (has_permission_new('production', '', 'create') || has_permission_new('production', '', 'view')) {
        $CI->app_menu->add_sidebar_children_item('production', [
                'slug'     => 'create-production',
                'name'     => 'Production',
                'href'     => admin_url('production/create_prd'),
                'position' => 2,
        ]);
    } 
  ...
  /*if (has_permission_new('recipe', '', 'view')) {
    ...
    $CI->app_menu->add_sidebar_children_item('Misc_Reports', [
                'slug'     => 'AcccountSubGroupList',
                'name'     => 'AcccountSubGroupList',
                'href'     => admin_url('accounts_master/AccountSubGroupList'),
                'position' => 15,
        ]);
    }
