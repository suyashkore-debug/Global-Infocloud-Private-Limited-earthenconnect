...
function register_staff_capabilities($feature_id, $config, $name = null,$main_menu = null)
{
    hooks()->add_filter('staff_permissions', function ($permissions) use ($feature_id, $config, $name, $main_menu) {
        ...
        if (!array_key_exists($feature_id, $permissions)) {
            ...
            /*if (!$main_menu) {
                $main_menu = str_replace('-', ' ', slug_it($feature_id));
                $main_menu = ucwords($feature_id);
            }*/

            $permissions[$feature_id]['name'] = $name;
            $permissions[$feature_id]['main_menu'] = $main_menu;
        }
