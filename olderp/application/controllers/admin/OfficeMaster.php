...
class OfficeMaster extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('OfficeMaster_model');
    ...
    public function index()
    {
        ...
        $data['RootCompany'] = $this->OfficeMaster_model->GetRootCompany();
        $this->load->model('accounts_master_model');
        $data['company_detail'] = $this->accounts_master_model->get_company_detail();
        $data['table_data'] = $this->OfficeMaster_model->get_table_data();
        $data['title'] = "OfficeMaster";
        $this->load->view('admin/OfficeMaster/Manage', $data);
    }
    ...
    public function GetOfficeDetailByID()
    {
        ...
        $AccountDetails = $this->OfficeMaster_model->get($AccountID);
        echo json_encode($AccountDetails);
    }
    
    /* Save New Accounts / ajax */
    public function SaveAccountID()
    {
        $data = array(
            ...
            'Redius'=>$this->input->post('Redius'),
        );
        $OfficeDetails  = $this->OfficeMaster_model->SaveAccountID($data);
    ...
    public function UpdateAccountID()
    {
        ...
        $AccountID = $this->input->post('AccountID');
        $AccountDetails   = $this->OfficeMaster_model->UpdateAccountID($data,$AccountID);
        echo json_encode($AccountDetails);
    }
