        ...
        foreach ($AllItemList as $key => $value) {
            ...
            if($from_date == $from_date_value){
                ...
                foreach ($StockOQtyData as $keyOQty => $valueOQty) {
                    ...
                    if(trim(strtoupper($valueOQty['ItemID'])) == trim(strtoupper($value["item_code"])) && $valueOQty['TType'] == "P"){
    ...
    public function get_stock_data()
     {
        ...
        foreach ($AllItemList as $key => $value) {
            ...
            $AdjCasesC = 0;
            foreach ($StockData as $key1 => $value1) {
                if(strtoupper($value["item_code"]) == strtoupper($value1["ItemID"]) && ($value1["TType"] == "X" && $value1["TType2"] == "Free Distribution" || $value1["TType"] == "X" && $value1["TType2"] == "Free distribution" || $value1["TType"] == "X" && $value1["TType2"] == "Promotional Activity" || $value1["TType"] == "X" && $value1["TType2"] == "Stock Adjustment")){
                    $AdjQtyC += $value1['BilledQty'];
                }
            }
            if($AdjQtyC !== '0'){
        ...
        foreach ($AllItemList as $key => $value) {
            ...
            $AdjCases = 0;
            foreach ($StockData as $key1 => $value1) {
                if(trim(strtoupper($value["item_code"])) == trim(strtoupper($value1["ItemID"])) && ($value1["TType"] == "X" && $value1["TType2"] == "Free Distribution" || $value1["TType"] == "X" && $value1["TType2"] == "Free distribution" || $value1["TType"] == "X" && $value1["TType2"] == "Promotional Activity" || $value1["TType"] == "X" && $value1["TType2"] == "Stock Adjustment")){
                    $AdjQty += $value1['BilledQty'];
                    if($value1["SaleRate"] !== '' || $value1["SaleRate"] !== null){
                        $rate = $value1["SaleRate"];
                    }
    ...
    public function get_production_data()
     {
        ...
        $html = '';
            ...
            if($report_type == 1 && empty($ItemID) && empty($accountID)){
                ...
                $html .= '<th align="left">Maneger Name</th>';
                $html .= '<th align="left">BOM Name</th>';
                ...
                $html .= '<th align="center" style="width:5%;">ItemID</th>';
                $html .= '<th align="left" style="width:30%;">ItemName</th>';
                $html .= '<th align="center" style="width:5%;">Pack Qty</th>';
                $html .= '<th align="center" style="width:10%;">Total Batch</th>';
                $html .= '<th align="center" style="width:10%;">STD. FG Qty.</th>';
                $html .= '<th align="center" style="width:10%;">Actual FG Qty</th>';
                $html .= '<th align="center" style="width:10%;">Diff. Qty</th>';
                $html .= '<th align="center" style="width:10%;">Actual FG Qty (Pack)</th>';
            ...
            foreach ($body_data as $key => $value) {
                ...
                if($report_type == 1 && empty($ItemID) && empty($accountID)){
                    ...
                    $stdprodqty = $value["batch_qty"]*$value["Finish_good_qty"];
                    $stdprodqty_total += $stdprodqty;
                    $diffqty = $stdprodqty - $value["Finish_good_qty_new"];
                    $diffqty_total += $diffqty;
                    $html .= '<td align="left">'.$con_st_name.'</td>';
                    $html .= '<td align="left">'.$value["description"].'</td>';
                    $html .= '<td align="right">'.$value["Finish_good_qty"].'</td>';
                    $html .= '<td align="right">'.$value["batch_qty"].'</td>';
                    $html .= '<td align="right">'.$value["Finish_good_qty"].'</td>';
                    $recstdQty_total +=$value["Finish_good_qty"];
