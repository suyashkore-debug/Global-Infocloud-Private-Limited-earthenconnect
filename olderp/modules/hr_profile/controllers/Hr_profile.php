...
public function update_staff_profile(){
  ...
  if ($data['id'] == '') {
	...
	public function AddEditStaff($id = '')
	{
		...
		$data['title']         = $title;
		$data['list_staff'] = $this->staff_model->get();
		$data['table_data'] = $this->hr_profile_model->staff_table_dataNew();
		/*echo "<pre>";
		...
		$data['staff_code'] = $this->hr_profile_model->create_code('staff_code');
        $data['SLDTYPE'] = $this->hr_profile_model->SLDTYPE();
        $data['SubGroup'] = $this->clients_model->StaffActSubgroup();
        $data['OfficeLocation'] = $this->hr_profile_model->GetOfficeLocation();
    ...
    public function GetAccountDetailByIDPOPUP()
    {
        $AccountID = $this->input->post('AccountID');
        $AccountDetails                    = $this->hr_profile_model->get_AccountDetailsPOPUP($AccountID);
        echo json_encode($AccountDetails);
    }
	//--------------------------------------------------
