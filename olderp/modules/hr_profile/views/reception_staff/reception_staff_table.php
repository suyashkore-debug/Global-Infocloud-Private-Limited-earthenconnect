...
foreach ($rResult as $aRow) {
    ...
    $action = ' <a  href="#" onclick="show_info_reception('.$aRow[db_prefix().'hr_rec_transfer_records.staffid'].');" ><i class="fa fa-pencil-square-o"></i></a> ';
    //$action .= ' <a  href="' . admin_url('hr_profile/delete_reception/' . $aRow[db_prefix().'hr_rec_transfer_records.staffid']) . '" class="text-danger" ><i class="fa fa-remove"></i></a></span>';
    $row[] = $action;
