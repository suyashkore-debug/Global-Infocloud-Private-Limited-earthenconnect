...
<div>
	<div class="_buttons">
		<?php if(has_permission('hrm_allowance_type', '', 'create') || is_admin() ){ ?>
		...
		<tbody>
			<?php foreach($allowance_type as $c){ ?>
				<tr>
					...
					<td>
						<?php if(has_permission('hrm_allowance_type', '', 'edit') || is_admin()){ ?>
						...
						<?php if(has_permission('hrm_allowance_type', '', 'delete') || is_admin()){ ?>
