...
<div>
	<div class="_buttons">
		<?php if(has_permission('hrm_salary_type', '', 'create') || is_admin() ){ ?>
			...
			<?php foreach($salary_form as $c){ ?>
				<tr>
					...
					<td>
						...
						<?php if(has_permission('hrm_salary_type', '', 'edit') || is_admin() ){ ?>
						...
						<?php if(has_permission('hrm_salary_type', '', 'delete') || is_admin() ){ ?>
