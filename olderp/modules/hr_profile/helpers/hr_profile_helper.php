 ...
 */
function get_distributor_name($userid = '')
{
    ...
    $CI = & get_instance();
        ...
        $staff = $CI->db->select('name')->from(db_prefix() . 'xx_customer_list')->get()->row();
    ...
    /**
     * hr profile get Role Name by id
    ...
    /**
     * hr profile get State Name by id
    ...
    function get_state_name_by_id($state_id){
        ...
        $role = $CI->db->get(db_prefix().'xx_statelist')->row();

        if($role){
            return $role->state_name; 
        }else{
            return ''; 
        } 
    }
     ...
     */
    function get_comp_name_by_id($_id){
        $CI             = &get_instance();
        $CI->db->where('id', $_id);
        $CI->db->select('comp_short');
        $role = $CI->db->get(db_prefix().'rootcompany')->row();

        if($role){
            return $role->comp_short; 
        }else{
            return ''; 
        } 
    }
    ...
    /**
     * hr profile get City Name by id
             
     */
    function get_city_name_by_city_id($id){
        $CI             = &get_instance();
        $CI->db->where('id', $id);
     ...
     */
    function get_city_name_by_state_id($id){
        $CI             = &get_instance();
        $CI->db->where('state_id', $id);
        $CI->db->select('city_name,id');
        $city = $CI->db->get(db_prefix().'xx_citylist')->result_array();
     ...
     */
    function get_hedquarter_name_by_state_id($id){
        $CI             = &get_instance();
        $CI->db->where('state_id', $id);
        $CI->db->select('name,id');
        $city = $CI->db->get(db_prefix().'headquarter')->result_array();
