            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                         ...
                         <?php  $vehicle_type = array("Own");
                    $vehicle_status = array("Select Status","Active","Deactive"); ?>

                        <h4 class="no-margin">Vehicle Add</h4>
                        ...
                        <div class="clearfix"></div>
                         ...
                         <div  class="col-md-4 leads-filter-column pull-left">
                          ...
                          <div  class="col-md-4 leads-filter-column pull-left form-group">
                                  ...
                                  <select name="staff" id="staff" data-live-search="false" class="form-control selectpicker"  data-actions-box="false" data-width="100%" data-none-selected-text="Vehicle type">
                            ...
                            <div  class="col-md-4 leads-filter-column pull-left form-group">
                                  ...
                                  <select name="staff1" id="staff1" data-live-search="false" class="selectpicker" data-actions-box="false" data-width="100%" data-none-selected-text="Vehicle status">
                                    <?php foreach($vehicle_status as $s) { ?>
                                      <option value="<?php echo htmlspecialchars($s); ?>"><?php echo htmlspecialchars($s); ?></option>
                                      <?php } ?>
                                  </select>
                            </div> 
                          ...
                          ?>
                            <?php echo render_date_input('date','', $today);
                            ?>
                          </div>
                          <div class="clearfix"></div>

                         <div class="btn btn-defualt text-right">
                     <button type="submit" class="btn btn-info">Add New Vehicle</button>
                  </div> 

                  <?php echo form_close(); ?>
                  <hr class="hr-panel-heading" />

                        <h4 class="no-margin">Vehicle List</h4>
                        <hr class="hr-panel-heading" />
                        ...
                        <div class="row">
                           ...
                           $type = array("Active","Deactive")
                           ?>
                           <div  class="col-md-3 leads-filter-column pull-left">
                              
                                  <select name="staff" id="staff" data-live-search="true" class="selectpicker" multiple="false"  data-actions-box="false" data-width="100%" data-none-selected-text="Vehicle Status">
...
<script>
    ...
    initDataTable(table_contract, admin_url+'vehicle/table_vehicle', undefined, undefined, ContractsServerParams,<?php echo hooks()->apply_filters('contracts_table_default_order', json_encode(array(1,'asc'))); ?>);
