...
/*foreach ($rResult as $aRow) {
    ...
    $row[] = "0";
    $row[] = "Fund receive";
    $row[] = '<a href="' . admin_url('account/receipt_edit/' . 1) . '" >' ."<i class='fa fa-pencil-square' style='font-size: 25px;'></i>". '</a>  &nbsp;&nbsp;&nbsp;<a href="' . admin_url('account/receipt_edit/' . 1). '" >' ."<i class='fa fa-trash' style='font-size: 25px;color: red;'></i>". '</a>';
