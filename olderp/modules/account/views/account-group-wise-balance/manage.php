            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                        ...
                        <h4 class="no-margin">Account Group Wise Balance</h4>
                  <hr class="hr-panel-heading" />
                        ...
                        <div class="row">
                           ...
                           $type = array("ACCRUED INCOME","ADDL CAPITAL","APPRENTICE PREMIUM","BAD DEBTS","BAD DEBTS RECOVERED","BANK BALANCE","BANK BORROWINGS","BILL PAYABLE","BILLS RECEIVABLES","CAPITAL","CAPITAL-SUB")
                           ?>
                           <div  class="col-md-3 leads-filter-column pull-left">
                          
                                  <select name="staff[]" id="staff" data-live-search="true" class="selectpicker" multiple="false" data-actions-box="false" data-width="100%" data-none-selected-text="Select Group">
...
<script>
    ...
    initDataTable(table_contract, admin_url+'account/table_group_wise_balance', undefined, undefined, ContractsServerParams,<?php echo hooks()->apply_filters('contracts_table_default_order', json_encode(array(1,'asc'))); ?>);
