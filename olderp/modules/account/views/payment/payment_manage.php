         ...
         <div class="col-md-12">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <h4 class="no-margin">Add New Payment Voucher</h4>
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                     ...
                     <h4 class="no-margin">Manage Payment Voucher</h4>   
                        <hr class="hr-panel-heading">
                        <?php
                        ...
                        <div class="row">
                            <div class="col-md-3 pull-left">
                                 ...
                                 <select name="staff" id="staff" data-live-search="true" class="selectpicker" multiple="false" data-actions-box="false" data-width="100%" data-none-selected-text="Filter By Voucher ID">
...
//combotree end 
    ...
    initDataTable(table_staff,admin_url + 'account/table_payment', '','', StaffServerParams);
