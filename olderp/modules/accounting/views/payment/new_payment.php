        ...
        <div class="panel-body">
          ...
          <div class="row">
            ...
            <?php
                ...
                if (has_permission_new('accounting_payment_entry', '', 'create')) {
                    ?>
                <button type="button" class="btn btn-info payment-entry-form-submiter" onclick="this.disabled = true"><?php echo _l('submit'); ?></button>
                <?php
                    }
                ?>
                <?php
            ...
            <div class="col-md-1" style="margin-top: 20px;">
              ...
              <a href="<?php echo admin_url('accounting/delete_payment_entry/' . $payment_entry->UniquID) ?>" class="btn btn-danger <?php echo $return;?>">Delete</a>
                <?php
                    }
                ?>
          </div>
         ...
         <table class="table text-right">
            <tbody>
               ...
               <tr>
                   <td><span class="bold" style="width: 14%;">Account Opening Balance :</span>
                  </td>
                  ...
                  <td><span class="bold" style="width: 19%;">Total Payment Amount :</span>
                  </td>
