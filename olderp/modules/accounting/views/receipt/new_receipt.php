      ...
      <div class="panel_s col-md-12">
        <div class="panel-body">
          ...
          <div class="row">
            ...
            ?>
            <button type="button" class="btn btn-info receipt-entry-form-submiter" onclick="this.disabled = true">Update</button>
            <?php
            }?>
                <?php
                }
                ...
                ?>
                <button type="button" class="btn btn-info receipt-entry-form-submiter" onclick="this.disabled = true"><?php echo _l('submit'); ?></button>
                <?php
                }
                ?>
                <?php
