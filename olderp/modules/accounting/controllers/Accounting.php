...
$i = 1;
    ...
    public function new_receipt_entry($id = ''){
        ...
        $this->load->view('receipt/new_receipt', $data);
    }
    ...
    public function get_data()
     {
       ...
       /* print_r($table_data);
        ...
        if($voucher_type == "CONTRA" || $voucher_type == "JOURNAL"){
            ...
            $html .= '<th>Dr/Cr</th>';
            $html .= '<th>Debit Amount</th>';
            $html .= '<th>Credit Amount</th>';
            $html .= '<th>Narration</th>';
            $html .= '<th>Address</th>';
        }else if($voucher_type == "PAYMENTS" || $voucher_type == "RECEIPTS"){
            $html .= '<th>Passed From</th>';
            $html .= '<th>Voucher Date</th>';
            $html .= '<th>Voucher No</th>';
            $html .= '<th>Account Name</th>';
            $html .= '<th>Amount</th>';
            $html .= '<th>Second Account Name</th>';
                ...
                foreach ($data_report as $key => $value) {
                    if($value["Amount"] !== "0.00"){
                        ...
                        if($value["PassedFrom"] == "SALE"){
                            ...
                            $url = admin_url().'purchase/order_list/'.$value["VoucherID"];
