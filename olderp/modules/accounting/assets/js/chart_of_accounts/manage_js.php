...
function init_account_table() {
  ...
  if ($.fn.DataTable.isDataTable('.table-accounts1')) {
    $('.table-accounts1').DataTable().destroy();
  }
  initDataTable('.table-accounts1', admin_url + 'accounting/table_for_chart_accounts', [0], [0,1,2,3,4,5], fnServerParams, []);
