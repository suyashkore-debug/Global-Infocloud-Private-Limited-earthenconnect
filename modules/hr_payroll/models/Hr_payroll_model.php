					...
					//probationary contract
						if($flag_contract == false && isset($staff_contracts[$task_timer['staff_id']]['probationary'])){
							if($staff_contracts[$task_timer['staff_id']]['probationary']['hourly_or_month'] == 'hourly_rate'){
								if($staff_contracts[$task_timer['staff_id']]['probationary']['primary_expiration'] == null){
									if(strtotime($staff_contracts[$task_timer['staff_id']]['probationary']['primary_effective']) <= strtotime($task_timer['start_time']) ){
									...
									if(strtotime($staff_contracts[$task_timer['staff_id']]['probationary']['primary_effective']) <= strtotime($task_timer['start_time']) &&  strtotime($task_timer['start_time']) <= strtotime($staff_contracts[$task_timer['staff_id']]['probationary']['primary_expiration'])){
