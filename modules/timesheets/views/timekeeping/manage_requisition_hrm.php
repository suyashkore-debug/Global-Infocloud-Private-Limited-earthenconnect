					...
					<div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Leave</b></li>
							</ol>
						</nav>
						<!--<div class="row">
							<div class="col-md-6">
														...
														<div class="form" id="new_requisition">
															...
															<div class="row">
																<div class="col-md-12">
																	...
																	<select name="staff" id="staff" data-live-search="true" class="selectpicker"  data-actions-box="true" data-width="100%" data-none-selected-text="<?php echo _l('none'); ?>">
																		<option value=""></option>
															...
															<div class="row approx-fr mtop10">
																...
																<div class="col-md-12 mtop10" id="number_days_off_2" >
																	<label class="control-label " id="days_off"><?php echo _l('number_of_days_off').': '.$days_off; ?></label><br>
																	<label  id="number_day_off" class="control-label  <?php if($number_day_off == 0){echo 'text-danger';} ?>"><?php echo _l('number_of_leave_days_allowed').': '.$number_day_off; ?></label>
																	<input type="hidden" id="number_day_offinput" name="number_day_offinput" aria-invalid="false">
																</div>
															</div>
															<br>
