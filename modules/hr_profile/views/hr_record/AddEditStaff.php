                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group" app-field-wrapper="designation">
                            ...
                            <select name="designation" id="designation" class="selectpicker form-control" data-width="100%" data-none-selected-text="None Selected" data-live-search="true">
                                <option value="">None Selected</option>
                    ...
                    <div class="col-md-2">
                        <div class="form-group" app-field-wrapper="StaffType">
                            ...
                            <select name="StaffType" id="StaffType" class="selectpicker form-control" data-width="100%" data-none-selected-text="None Selected" data-live-search="true">
                                <option value="">None Selected</option>
                            <?php
					...
					<div class="col-md-2">
						<div class="form-group">
                            ...
                            <select name="EmpType" class="selectpicker" id="EmpType" data-width="100%" data-none-selected-text="None selected" data-live-search="true"> 
                                <option value="">None selected</option>
                    ...
                    <div class="col-md-2">
                        <div class="form-group" app-field-wrapper="reporting_to">
                            ...
                            <select name="reporting_to" id="reporting_to" class="selectpicker form-control" data-width="100%" data-none-selected-text="None Selected" data-live-search="true">
                                <option value="">None Selected</option>
                            <?php
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="opening_b" id="opening_b" value="0" class="form-control" <?php if(isset($client) && $staff_user_id !== "3"){ echo "disabled";}?> >
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group" app-field-wrapper="EmergencyContact">
                            ...
                            <input type="text" id="EmergencyContact" name="EmergencyContact" class="form-control" value="" maxlength="10" minlength="10" onkeypress="return isNumber(event)">
                        </div>
                    </div>
					...
					<div class="col-md-2">
                        <div class="form-group" app-field-wrapper="state">
                            ...
                            <select name="Permanentstate" id="Permanentstate" class="selectpicker form-control" data-width="100%" data-none-selected-text="Non Selected" data-live-search="true">
                                <option value="">Non Selected</option>
                            <?php
                                foreach ($state as $key => $value) {
                            ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                           <small class="req text-danger">* </small>
                            ...
                            <select class="form-control city selectpicker" data-width="100%" data-none-selected-text="None Selected" name="Permanentcity" id="Permanentcity" data-live-search="true">
                                <option value="">None selected</option>
                            </select>
					...
					<div class="col-md-3">
                        <div class="form-group" app-field-wrapper="PermanentAddressline2">
                            ...
                            <input type="text" id="PermanentAddressline2" name="PermanentAddressline2" class="form-control" value="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">	
						...
						<input type="text"  name="ifsc" id="ifsc" class="form-control" value="<?php echo $account_number?>">
					</div>
					...
					<div class="col-md-3">
						<?php					
						echo render_input('name_account','Account Holder Name','', 'text'); ?>
					</div>
					
					 <div class="col-md-3">
                        <div class="form-group" app-field-wrapper="BranchAddress">
                            <label for="BranchAddress" class="control-label">Branch Address</label>
                            <input type="text" id="BranchAddress" name="BranchAddress" class="form-control" value="<?php echo $BranchAddress?>">
                        </div>
                    </div> 
                    ...
                    <div class="col-md-2">
						<div class="form-group">
							<label for="marital_status" class="control-label"><?php echo _l('Marital Status'); ?></label>
                    ...
                    <div class="col-md-2">
                        <?php 
                            //$curDate = date('d/m/Y');
                        echo render_date_input( 'birthday', 'Date of Birth','','date'); ?>
                    </div>
                    
                    <div class="col-md-2">
						<div class="form-group">
                            <label for="BloodGroup" class="control-label">Blood Group</label>
                            <select name="BloodGroup" class="selectpicker" id="BloodGroup" data-width="100%" data-none-selected-text="None selected" data-live-search="true"> 
                                <option value="">None selected</option>
								<!-- Common Blood Groups -->
                    ...
                    <div class="col-md-2">
					    <div class="form-group">
						    <label for="literacy" class="control-label"><?php echo _l('Academic Level'); ?></label>
						    <select name="literacy" id="literacy" class="selectpicker" data-width="100%" data-none-selected-text="None selected">
							    <option value=""></option>
                    ...
                    <!--<div class="col-md-2">
						<?php 
						//$curDate = date('d/m/Y');
						echo render_date_input('datecreated','Started Date','','date'); ?>
					</div>-->
					...
					<div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="working_hour" id="working_hour" value="0" class="form-control" onkeypress="return isNumber(event)">
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
						<div class="form-group">
                            ...
                            <select name="IsPF" class="selectpicker" id="IsPF" data-width="100%" data-none-selected-text="None selected"> 
					...
					<div class="col-md-2">
						<div class="form-group">
                            ...
                            <select name="IsESIC" class="selectpicker" id="IsESIC" data-width="100%" data-none-selected-text="None selected"> 
                                <option value="Y">Yes</option>
                                <option value="N">No</option>
                            </select>
                        </div>
    ...
    // Save New Item
        ...
        if(AccountID == ''){
            ...
            $.ajax({
                ...
                dataType:"JSON",
                method:"POST",
                data:{AccountID:AccountID,firstname:firstname,lastname:lastname,Department:Department,designation:designation,StaffType:StaffType,
    ...
    // Update Exiting Item
        ...
        if(AccountID == ''){
            ...
            $.ajax({
                ...
                dataType:"JSON",
                method:"POST",
                data:{userID:userID,AccountID:AccountID,firstname:firstname,lastname:lastname,Department:Department,designation:designation,StaffType:StaffType,
                        reporting_to:reporting_to,opening_b:opening_b,phonenumber:phonenumber,altphonenumber:altphonenumber,email:email,peremail:peremail,
                        state:state,city:city,address1:address1,address2:address2,zip:zip,Pan:Pan,Aadhaarno:Aadhaarno,
                        ifsc:ifsc,issue_bank:issue_bank,account_number:account_number,name_account:name_account,sex:sex,marital_status:marital_status,
