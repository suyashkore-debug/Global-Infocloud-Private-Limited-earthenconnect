...
//print_r($member); ?>
				<table class="table border table-striped ">
					<tbody>
						...
						<tr class="project-overview">
							<td class="bold" width="40%"><?php echo _l('staff_add_edit_role'); ?></td>
							<td><?php $role = get_role_name_by_id($member->role);
							echo $role;
							?></td>
						</tr>
						<tr class="project-overview">
						...
						<tr class="project-overview">
							<td class="bold" width="30%"><?php echo _l('hr_state'); ?></td>
							<td><?php $state_name = get_state_name_by_id($member->state);
							echo $state_name;
							?></td>
						</tr>
						<tr class="project-overview">
