					...
					<div class="panel-body">
						 <nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Job Designation</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">
							<span class="edit-title"><?php //echo _l('hr_edit_job_rank'); ?>Edit Designation</span>
							<span class="add-title"><?php //echo _l('hr_new_job_rank'); ?> Add Designation</span>
						</h4>
					</div>
						...
						<div role="tabpanel" class="tab-pane active" id="general_infor">
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form">     
										<?php echo render_input('position_code','Code'); ?>
									</div>
								</div>
								<div class="col-md-6">
									<?php 
									echo render_input('position_name','Designation'); ?>
								</div>
							...
							<div class="row">
								<div class="col-md-12">
									<p class="bold"><?php //echo _l('hr_job_descriptions'); ?>Descriptions</p>
