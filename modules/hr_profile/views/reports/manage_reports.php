            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                    ...
                    <p><a href="#" class="font-medium" onclick="init_report(this,'report_the_employee_quitting'); return false;"><i class="fa fa-caret-down" aria-hidden="false"></i> <?php echo _l('hr_report_the_employee_quitting'); ?></a></p>
                    <hr class="hr-10" />
