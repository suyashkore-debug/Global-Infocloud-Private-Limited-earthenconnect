            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                        ...
                        <h4 class="no-margin">TCS Reports</h4>
...
<script>
    ...
    initDataTable(table_contract, admin_url+'account/table_tcs_reports', undefined, undefined, ContractsServerParams,<?php echo hooks()->apply_filters('contracts_table_default_order', json_encode(array(1,'asc'))); ?>);
