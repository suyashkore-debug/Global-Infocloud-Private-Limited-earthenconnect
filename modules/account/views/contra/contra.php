...
//print_r($pro);
    ...
    ?>
                  ...
                  <?php echo render_textarea('note','Narration','',array('rows'=>4),array()); ?>

                    </div>
                    <div  class="col-md-4 leads-filter-column pull-left" style="margin-top: 5%;">
...
//combotree end 
    ...
    initDataTable(table_staff,admin_url + 'account/table_contra_entry2', '','', StaffServerParams);
