...
//print_r($pro);
                    ...
                    $Payment_code = array("CASH","CPRO","CD","OBSA","PRC");
                           ...
                           ?>
                           <div  class="col-md-6 leads-filter-column pull-left">

                            <?php echo render_input('voucher_id','Voucher ID','21','number');
                     ...
                     ?> 
                           ...
                           <div  class="col-md-6 leads-filter-column pull-left">
                          <?php echo render_date_input('date','Voucher Date');
                          ?>
                        </div>
                           <div  class="col-md-12 leads-filter-column pull-left form-group">
                           ...
                           <!--  <div  class="col-md-6 leads-filter-column pull-left form-group">
                             ...
                             <div  class="col-md-12 leads-filter-column pull-left">
                   ...
                   <!-- <i class="fa fa-question-circle pull-left" data-toggle="tooltip" data-title="We can added your Narration"></i> -->
                  <?php $value = (isset($expense) ? $expense->note : ''); ?>
                  <?php echo render_textarea('note','Narration',$value,array('rows'=>4),array()); ?>
