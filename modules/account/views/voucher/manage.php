            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                        ...
                        <h4 class="no-margin">Voucher Register</h4>
                  <hr class="hr-panel-heading" />
                        ...
                        <div class="row">
                           ...
                           $type = array("Contra","Journal","Receipts","Payment","Sales Receipts")
                           ?>
                           <div  class="col-md-3 leads-filter-column pull-left">
                          
                                  <select name="staff[]" id="staff" data-live-search="true" class="selectpicker" multiple="false" data-actions-box="false" data-width="100%" data-none-selected-text="Select Voucher">
...
<script>
    ...
    initDataTable(table_contract, admin_url+'account/table_voucher_register', undefined, undefined, ContractsServerParams,<?php echo hooks()->apply_filters('contracts_table_default_order', json_encode(array(6,'asc'))); ?>);
