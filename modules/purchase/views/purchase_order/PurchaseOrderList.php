							...
							<div class="panel-body">
								<nav aria-label="breadcrumb">
                    				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                    					...
                    					<li class="breadcrumb-item active" aria-current="page"><b>Purchase Orders List</b></li>
                    				</ol>
                                </nav>
                                <hr class="hr_style">
								<br>
										...
										<div class="table_purchase_report">
											...
											<table class="tree table table-striped table-bordered table_purchase_report" id="table_purchase_report" width="100%">
												...
												<thead>
													...
													<tr>
														<th class="sortable" style="width:7% ">PO. No.</th>
														<th class="sortable" style="width:5% ">Date</th>
														<th class="sortable" style="width:15% text-align:left;">Purchased From</th>
														<th class="sortable" style="width:10% " align="right">Purchase Amt</th>
														<th class="sortable" style="width:6% " align="right">Disc Amt</th>
														<th class="sortable" style="width:9% " align="right">CGST Amt</th>
														<th class="sortable" style="width:9% " align="right">SGST Amt</th>
														<th class="sortable" style="width:9% " align="right">IGST Amt</th>
														<th class="sortable" style="width:9% " align="right">Inv. Amt</th>
			...
			$.ajax({
				...
				success:function(data){
					...
					for(var count = 0; count < data.length; count++)
					{
						...
						html += '<tr onclick="location.href='+url+'" target="_blank">';
...
<script type="text/javascript">
	function printPage(){
		...
		heading_data += '<tr>';
		heading_data += '<td style="text-align:center;"colspan="9">Purchase Order Report : '+from_date+' To '+to_date+' - Status : '+status+'</td>';
		heading_data += '</tr>';
	...
	var status = $("#status").val();
	    ...
	    $.ajax({
            url:"<?php echo admin_url(); ?>purchase/export_purchase_order_PO",
            method:"POST",
            data:{from_date:from_date, to_date:to_date,status:status},
            beforeSend: function () {
