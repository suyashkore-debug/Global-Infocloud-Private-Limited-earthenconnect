	...
	<div class="content">
      ...
      <nav aria-label="breadcrumb">
                    				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                    					...
                    					<li class="breadcrumb-item active" aria-current="page"><b>Purchase Return</b></li>
                    				</ol>
                                </nav>
                                <hr class="hr_style">
           <?php
            ...
            <div class="tab-content">
                <?php if($customer_custom_fields) { ?>
                 <div role="tabpanel" class="tab-pane" id="custom_fields">
                    ...
                    <?php echo render_custom_fields( 'purrtn_order',$rel_id); ?>
                 </div>
                <?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        $new_purchase_orderNumbar = get_option('next_purchasertn_number_for_cspl');
                    }elseif($selected_company == 2){
                        $new_purchase_orderNumbar = get_option('next_purchasertn_number_for_cff');
                    }elseif($selected_company == 3){
                        $new_purchase_orderNumbar = get_option('next_purchasertn_number_for_cbu');
                    }elseif($selected_company == 4){
                        $new_purchase_orderNumbar = get_option('next_purchasertn_number_for_cbupl');
                    }
                 ...
                 ?> 
                    ...
                    <span class="input-group-addon">
                      ...
                      <!--<input type="text" name="pro_orderid" id="pro_orderid" class="form-control receiptsid" value="" >-->
                    </div>
                    </div>
                            ...
                            <label for="vendor">Vendor Name</label>
                                <select name="vendor" id="vendor" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" >
                                  <option value=""></option>
                                    ...
                                    <option data-id="<?php echo html_entity_decode($s['AccountID']); ?>" value="<?php echo html_entity_decode($s['userid']); ?>" ><?php echo html_entity_decode($s['company'])." - ".html_entity_decode($s['AccountID']); ?></option>
                                      <?php } ?>
                                </select>  
                                <br><br>
                          </div>
                ...
                ?>
                            ...
                            echo render_date_input('purch_rtn_date','Purchase Return Date',$order_date); ?>
                        </div>
               ...
               <tbody>
                  <tr id="total_td">
                     ...
                     <td width="50%" id="total_td">
                      <label style="float: left; padding: 9px;width: 92px;" for="PurchaseAmt">PurchRtn Amt</label>  
                  ...
                  <tr id="discount_area">
                     ...
                     <label style="float: left; padding: 9px 9px 9px 0px;width: 92px;" for="<?php echo _l('subtotal'); ?>">Invoice AMT</label>  
                          <div class="input-group" id="discount-total">
                             <input type="text" value="<?php if(isset($pur_order)){ echo $pur_order->discount_total; } ?>" class="form-control pull-left text-right" onchange="dc_total_change(this); return false;" data-type="currency" name="Invoice_amt">
<input type="hidden" id="purchase_id_store" name="purchase_id_store">
<input type="hidden" id="purchase_id_check" name = "purchase_id_check"> 
          ...
          <div class="col-md-12 mtop15">
             <div class="panel-body bottom-transaction">
                ...
                <div class="btn-bottom-toolbar text-right" style="width: 100%;">
                  <?php if (has_permission_new('purchase-return', '', 'create')){
                      ?>
              ...
              <table class="tree table table-striped table-bordered table_purchase_report" id="table_purchase_report" width="100%">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th style="width:5% text-align:left;">Invoce Date</th>
                    <th style="width:5% text-align:left;">Purch Qty</th>
                    <th style="width:3% text-align:left;">Case Qty</th>
                    <th style="width:5% text-align:left;">Cases</th>
                    <th style="width:5% text-align:left;">Purch Rate</th>
                    ...
                    <th style="width:5% text-align:left;">Rtn Qty</th>
              ...
              <table class="tree table table-striped table-bordered table_purchase_report1" id="table_purchase_report1" width="100%">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="sortablePop" style="width:7% ">Purch Rtn ID</th>
                    <th class="sortablePop" style="width:5% ">Trans Date</th>
                    <th class="sortablePop" style="width:15% text-align:left;">Return To</th>
                    <th class="sortablePop" style="width:5% text-align:left;">Return Amt</th>
                    <th class="sortablePop" style="width:3% text-align:left;">Dsc Amt</th>
                    ...
                    <th class="sortablePop" style="width:5% text-align:left;">Exc Amt</th>
                    <th class="sortablePop" style="width:5% text-align:left;">Vat Amt</th>
                    <th class="sortablePop" style="width:5% text-align:left;">Frt Amt</th>
                    <th class="sortablePop" style="width:5% text-align:left;">Oth Amt</th>
                    <th class="sortablePop" style="width:5% text-align:left;">Net Return Amt</th>
...
<script>
	...
	$(document).on("click", ".sortablePop", function () {
		var table = $("#table_purchase_report1 tbody");
