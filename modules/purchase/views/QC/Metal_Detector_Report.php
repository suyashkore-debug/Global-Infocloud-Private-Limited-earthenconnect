				...
				<div class="panel_s accounting-template estimate">
											...
											<div class="col-md-2">
												<?php
													...
													if($selected_company == 1){
														...
														$new_purchase_orderNumbar = get_option('next_metal_detector_test_number_for_cspl');
													}
					...
					<div class="panel-body mtop10">
						<div class="row col-md-12">
							<p class="bold p_style"><?php echo "Metal Detector Report" ?></p>
							<hr class="hr_style"/>
						...
						<div class="col-md-12 mtop15">
							<div class="btn-bottom-toolbar text-right" style="width: 100%;">
								...
								<?php
									...
									{
										if (has_permission_new('Metal_Detector', '', 'edit'))
										{ 
										?>
									...
									{
										if (has_permission_new('Metal_Detector', '', 'create')){
										?>
	...
	<div class="modal-dialog pup100" >
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Metal Detector Report List</h4>
			</div>
...
<?php init_tail(); ?>
<?php $this->load->view('QC/Metal_Detector_Report_js.php'); ?>
</body>
...
<script>
	$(document).ready(function(){
		...
		{
			$.ajax({
				url:"<?php echo admin_url(); ?>purchase/load_data_for_metal_detector_entry",
				dataType:"JSON",
				method:"POST",
