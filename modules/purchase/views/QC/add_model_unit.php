        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                    <span class="edit-title">Edit Unit</span>
                    <span class="add-title">Add Unit</span>
                </h4>
            </div>
            <?php echo form_open('admin/purchase/manage_unit',array('id'=>'vehicle_form')); ?>
            <?php echo form_hidden('itemid'); ?>
            <div class="modal-body">
                <div class="row">
                      <div class="col-md-4">
                        <?php echo render_input('name','Unit Name'); ?>
                    </div>
                    <div class="col-md-4">
                        <?php echo render_input('Measured_in','Measured In'); ?>
                    </div>
...
function init_item_js() {
    ...
    $("body").on('show.bs.modal', '#route_modal', function (event) {
        ...
        if (typeof (id) !== 'undefined') {
            ...
            requestGetJSON('purchase/get_unit_by_id/' + id).done(function (response) {
                $itemModal.find('input[name="name"]').val(response.unit_name);
                $itemModal.find('input[name="Measured_in"]').val(response.measured_in);
