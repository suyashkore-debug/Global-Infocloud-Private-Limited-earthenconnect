				...
				<div class="panel_s accounting-template estimate">
							...
							<div class="panel-body">
								...
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
										...
										<li class="breadcrumb-item active" aria-current="page"><b>Finish Good Test </b></li>
									</ol>
								</nav>
								<hr class="hr_style">
											...
											<div class="col-md-2">
												<?php
													...
													if($selected_company == 1){
														...
														$new_purchase_orderNumbar = get_option('next_QC_FG_Test_number_for_cspl');
													}
					...
					<div class="panel-body mtop10">
						<div class="row col-md-12">
							<p class="bold p_style"><?php echo "Finish Good Test Report" ?></p>
							<hr class="hr_style"/>
						...
						<div class="col-md-12 mtop15">
							<div class="btn-bottom-toolbar text-right" style="width: 100%;">
								...
								<?php
									...
									{
										if (has_permission_new('Fg_Test', '', 'edit'))
										{ 
										?>
									...
									{
										if (has_permission_new('Fg_Test', '', 'create')){
										?>
	...
	<div class="modal-dialog pup100" >
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Finish Goods Test Report List</h4>
			</div>
...
<?php init_tail(); ?>
<?php $this->load->view('QC/FG_Test_Report_js.php'); ?>
</body>
...
<script>
	$(document).ready(function(){
		...
		{
			$.ajax({
				url:"<?php echo admin_url(); ?>purchase/load_data_for_fg_test_entry",
				dataType:"JSON",
				method:"POST",
