				...
				<div class="panel_s">
					<div class="panel-body">
            				...
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>QC Parameter</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<?php hooks()->do_action('before_items_page_content'); ?>
						<?php if(has_permission('qc_parameter','','create')){ ?>
							
							<div class="_buttons">
								<a href="#" class="btn btn-info pull-left" data-toggle="modal" data-target="#route_modal">Add Parameter</a>
							</div>
								...
								<table class="table table-striped table-bordered tableFixHead2" width="100%" id="user_list">
									<thead>
										<tr>
											...
											<th class="sortablePop">Unit Name</th>
										...
										<?php
											...
											<tr>
												...
												<?php $action = '';
													...
													if (has_permission_new('qc_parameter', '', 'delete')) {
														$action .= ' &nbsp&nbsp&nbsp<a href="#" Onclick="DeleteParameter(' . $value['id'] . ')" ><i class="fa fa-trash"> </i></a>';
...
<?php $this->load->view('QC/add_model_parameter'); ?>
<style>
...
<script>
    function DeleteParameter(id){
		...
		if(confirm("Are you sure you want to delete")){
			$.ajax({
				url:"<?php echo admin_url(); ?>purchase/DeleteQCParameter",
				dataType:"JSON",
				method:"POST",
				data:{id:id},
				beforeSend: function () {
...
<script>
	$("#caexcel").click(function(){
		var data_val = "data";
		$.ajax({
			url:"<?php echo admin_url(); ?>purchase/export_QC_Parameter",
			method:"POST",
...
<script type="text/javascript">
	function printPage(){ 
		...
		heading_data += '<tr>';
		heading_data += '<td style="text-align:center;"colspan="4">QC Parameter Master</td>';
		heading_data += '</tr>';
