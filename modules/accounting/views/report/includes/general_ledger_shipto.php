        ...
        <div class="panel-body">
						...
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Ship To Account Ledger</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
              ...
              <?php //echo form_open(admin_url('accounting/view_report2'),array('id'=>'filter-form')); ?>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group" app-field-wrapper="accounting_method">
                      <label for="accounting_method" class="control-label">Select Account</label><?php echo $AccountID_for_ledger; ?>
...
<script>
    function Show_ladger(){
        /*$('#show_ledger').on('click',function(){*/
        	...
        	$.ajax({
              url:"<?php echo admin_url(); ?>accounting/view_report2_shipto",
              dataType:"JSON",
              method:"POST",
...
$("#caexcel").click(function(){
  var from_date = $("#from_date").val();
	    ...
	    $.ajax({
            url:"<?php echo admin_url(); ?>accounting/export_general_ledger_shipto",
            method:"POST",
           data:{from_date:from_date, to_date:to_date, accounting_method:accounting_method},
            beforeSend: function () {
