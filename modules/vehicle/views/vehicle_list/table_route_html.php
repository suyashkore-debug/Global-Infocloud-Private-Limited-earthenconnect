...
*/
    ...
    $row[] = "17";
    $row[] = $status;
    $row[] = '<a href="' . admin_url('vehicle/route_manage') . '" >' ."<i class='fa fa-pencil-square' style='font-size: 25px;'></i>". '</a>  &nbsp;&nbsp;&nbsp;<a href="' . admin_url('vehicle/route_manage'). '" >' ."<i class='fa fa-trash' style='font-size: 25px;color: red;'></i>". '</a>';
