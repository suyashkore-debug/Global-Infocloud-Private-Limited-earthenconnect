...
//print_r($pro);
                        ...
                        ?>
                          ...
                          <div  class="col-md-3 leads-filter-column pull-left form-group">
                             <!-- <label>Route</label> -->
                              <select name="staff_role[]" id="staff_role" data-live-search="true" class="selectpicker" multiple="false" data-actions-box="false" data-width="100%" data-none-selected-text="Select Route ">
                          ...
                          <?php
                        $vehicle = array("UP53BT6925","UP53BT7412","UP53BT7413","UP53BT7689","UP53BT8305","UP53BT9991","UP53CT6144","UP53CT8785");
                        ?>
                          
                          <div  class="col-md-3 leads-filter-column pull-left form-group">
                            <!-- <label>Vehicle</label> -->
                              <select name="staff1" id="staff1" data-live-search="true" class="selectpicker" multiple="false" data-actions-box="false" data-width="100%" data-none-selected-text="Select Vehicle ">
                          ...
                          <?php
                          $vehicle = array("APB","UP53BT7412","UP53BT7413","UP53BT7689","UP53BT8305","UP53BT9991","UP53CT6144","UP53CT8785")
                          ?>
                          
                           <div  class="col-md-2 leads-filter-column pull-left form-group">

                              <!-- <label>Driver ID</label> -->
                                  <select name="staff2" id="staff2" data-live-search="true" class="selectpicker" multiple="false" data-actions-box="false" data-width="100%" data-none-selected-text="Driver id">
                          ...
                          <div  class="col-md-2 leads-filter-column pull-left form-group">
                              ...
                              <!-- <label>Loader ID</label> -->
                                  <select name="staff3" id="staff3" data-live-search="true" class="selectpicker" multiple="false" data-actions-box="false" data-width="100%" data-none-selected-text="Loader Id">
                                    <?php foreach($vehicle_type as $s) { ?>
                                      <option value="<?php echo htmlspecialchars($s); ?>"><?php echo htmlspecialchars($s); ?></option>
                                      <?php } ?>
                                  </select>
