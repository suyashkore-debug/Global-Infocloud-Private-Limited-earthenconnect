   ...
   <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 authentication-form-wrapper">
    ...
    <div class="mtop40 authentication-form">
      ...
      <div class="form-group">
        ...
        <label for="email1" class="control-label"><?php echo _l('admin_auth_login_mobile'); ?></label>
        <input type="text" id="email1" name="email1" class="form-control" autofocus="1" required>
      </div>
      <div class="form-group">
