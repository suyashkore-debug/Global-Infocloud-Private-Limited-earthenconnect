					...
					<div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Market Outstanding</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<?php
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													...
													echo render_date_input('as_on','As on Date',$order_date); ?>
												</div>
											</div>
											<div class="col-md-8">
												<div class="form-group">
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<select name="loc_type" id="loc_type" class="selectpicker" data-none-selected-text="Non selected" data-width="100%" data-live-search="true">
														...
														<option value="3" selected data-name="NotDefined">Not Defined</option>
													</select>
...
<script>
    $(document).ready(function(){
		...
		$(document).on("click", ".sortable", function () {
			var table = $("#table-market_outstanding tbody");
