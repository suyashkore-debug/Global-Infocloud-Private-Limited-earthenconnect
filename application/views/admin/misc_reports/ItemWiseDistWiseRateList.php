          ...
          <div class="panel-body">
				<nav aria-label="breadcrumb">
    				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    					...
    					<li class="breadcrumb-item active" aria-current="page"><b>Item Wise Distributor Type Rate List</b></li>
					</ol>
				</nav>
                <hr class="hr_style">
                <div class="row">
                    <div class="col-md-3">
                        <div class="row">
                            ...
                            <div class="col-md-12">
    							<div class="form-group" app-field-wrapper="distributor_id">
    							    <label for="states" class="control-label">Dist. Type</label>
        							<select name="distributor_id[]" class="selectpicker" id="distributor_id" data-width="100%" data-live-search="true" multiple="true" data-actions-box="true" data-none-selected-text="None Selected" tabindex="-98">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="custom_button">
                            ...
                            <a class="btn btn-info search_data" href="#" id="search_data" style="font-size:12px;margin-top: 8px;">Show</a>
                            <a class="btn btn-default buttons-excel buttons-html5" tabindex="0" aria-controls="stock_position" href="#" id="caexcel" style="font-size:12px;margin-top: 8px;"><span>Export</span></a>
                            <!--<a class="btn btn-default" href="javascript:void(0);" onclick="printPage();" style="font-size:12px;margin-top: 8px;">Print</a>-->
                        </div>
                    </div>
                    <div class="col-md-4">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12"><span id="searchh" style="display:none;">Loading.....</span></div>
                    <div class="col-md-12">
...
.stock_position          { overflow: auto;max-height: 55vh;width:100%;position:relative;top: 0px; }
.stock_position thead th { position: sticky; top: 0;background-color: #626f80;color: #fff; }
/*.stock_position thead th { position: sticky;left: 0; }*/
.stock_position th, td { padding: 1px 5px !important; border:1px solid #ddd !important;font-size:11px; line-height:1.42857143!important;vertical-align: middle !important;}
.fixed-header {
    z-index: 50;
}
    .col-srno {
...
$(document).ready(function(){
 ...
 $('#search_data').on('click',function(){
	    ...
	    $.ajax({
          url:"<?php echo admin_url(); ?>misc_reports/get_itemwise_distwise_rate_report",
          dataType:"JSON",
          method:"POST",
          cache: false,
 ...
 $("#caexcel").click(function(){
  var states = $("#states").val();
	    ...
	    $.ajax({
            url:"<?php echo admin_url(); ?>misc_reports/export_itemwise_distwise_rate_list",
            method:"POST",
            data:{states:states, distributor_id:distributor_id, item_group:item_group,item_data:item_data},
            beforeSend: function () {
