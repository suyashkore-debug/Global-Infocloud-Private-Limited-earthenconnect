			...
			<div class="col-md-12">
			   ...
			   <nav aria-label="breadcrumb">
                    				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                    					...
                    					<li class="breadcrumb-item active" aria-current="page"><b>Party Wise Rate Report</b></li>
                    				</ol>
                                </nav>
                                <hr class="hr_style">
							<div class="row">
								...
								<div class="col-md-3">
									...
									<select name="Subgroup" class="selectpicker" id="Subgroup" data-width="100%"  data-live-search="true"> 
										<?php 
								...
								<div class="col-md-3 ">
									...
									<select name="RateType" class="selectpicker" id="RateType" data-width="100%" > 
...
<script>
	$(document).ready(function(){
		...
		function load_data(RateType,Subgroup)
		{
			$.ajax({
				url:"<?php echo admin_url(); ?>misc_reports/GetPartyWiseRateReport",
				dataType:"json",
				method:"POST",
				data:{RateType:RateType,Subgroup:Subgroup},
				beforeSend: function () {
				...
				success:function(data){
					...
					var msg = "Party Wise Rate Report";
					$(".report_for").text(msg);
...
<script>
	...
	$("#caexcel").click(function(){
	    ...
	    $.ajax({
            url:"<?php echo admin_url(); ?>misc_reports/export_PartyWiseRateReport",
            method:"POST",
            data:{Subgroup:Subgroup, RateType:RateType},
            beforeSend: function () {
