          ...
          <div class="panel-body">
				...
				<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Unit Wise Stock Position</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
              <div class="_buttons">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group" app-field-wrapper="GodownID">
                                ...
                                <select name="GodownID" id="GodownID" class="selectpicker form-control" data-none-selected-text="None Selected" data-live-search="true" <?php echo $GodownStatus;?>>
                        ...
                        <div class="col-md-4" style="padding-left: 0px;margin-top: 5px;">
                            <br>
...
$(document).ready(function(){
 ...
 $('#search_data').on('click',function(){
	    ...
	    if(item_group == "" || item_group== null){
	        ...
	        $.ajax({
          url:"<?php echo admin_url(); ?>misc_reports/get_unit_wise_stock_data",
          dataType:"JSON",
          method:"POST",
          cache: false,
 ...
 $("#caexcel").click(function(){
  ...
  $.ajax({
            url:"<?php echo admin_url(); ?>misc_reports/export_unit_wise_stock_report",
            method:"POST",
           data:{from_date:from_date, to_date:to_date,GodownID:GodownID,item_group:item_group,item_main_group:item_main_group},
            beforeSend: function () {
...
$(document).ready(function(){
   ...
   /* console.log(minStartDate);
	...
	$(document).on("click", ".sortable", function () {
		var table = $("#stock_positionFilter");
