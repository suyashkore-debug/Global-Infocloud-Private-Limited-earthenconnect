					...
					<div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>TCS Master</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
								...
								<div class="tableFixHead2">
									<table class="table table-striped table-bordered tableFixHead2" width="100%" id="user_list">
										<thead>
											...
											<tr>
												<th class="sortablePop">TCS %</th>
												<th class="sortablePop">Effected Date</th>
												<th class="sortablePop">Created staff</th>
