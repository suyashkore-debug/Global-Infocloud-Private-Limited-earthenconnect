					...
					<div class="panel-body">
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
								...
								<li class="breadcrumb-item active" aria-current="page"><b>Sales Return</b></li>
							</ol>
						</nav>
						<hr class="hr_style">
									...
									<div class="col-md-8">
										<div class="row">
											...
											<div class="col-md-3" style="padding-right: 0px;">
												...
												<?php echo render_date_input('sale_return_date','Date',$value,$attr); ?>
												<?php
													if(isset($sale_return)){ ?>
											...
											<div class="col-md-3" style="padding-left: 10px;">
												...
												<?php $value = (isset($sale_return) ? $sale_return->cd_note_no : ''); ?>
												<input type="text" name="cd_note_no" id="cd_note_no" class="form-control" value="<?php echo $value; ?>">
												
											</div>
											<div class="col-md-3" style="padding-left: 10px;">
												<?php $value = (isset($sale_return) ? _d(substr($sale_return->cd_note_date,0,10)) : $to_date); ?>
												<?php echo render_date_input('cd_note_date','Credit Note Date',$value); ?>
										...
										<div class="row">
											<div class="col-md-3" style="padding-right: 0px;">
												...
												<?php $value2 = (isset($sale_return) ? $sale_return->AccountID2 : ''); ?>
												<?php
													if(isset($sale_return)){ ?>
													<input type="hidden" name="old_act_name" id="old_act_name" value="<?php echo $value; ?>">
													<input type="hidden" name="old_act_name2" id="old_act_name2" value="<?php echo $value2; ?>">
												<?php } ?>
												...
												<div class="form-group">
													<label for="act_name" class="control-lable">Return From</label>
													<select name="act_name" id="act_name" class="selectpicker form-control" data-none-selected-text="None selected" data-live-search="true">
											...
											<div class="col-md-3" style="margin-top: 19px;padding: 0px;">
												...
												<input type="text" name="gst_no" readonly id="gst_no" class="form-control" value="<?php echo $value; ?>">
											</div>
											<div class="col-md-1" style="margin-top: 19px;padding: 0px;">
												<?php $value = (isset($sale_return) ? $sale_return->accounts->state : ''); ?>
												<input type="text" name="account_state" readonly id="account_state" class="form-control" value="<?php echo $value; ?>">
												
											</div>
											<div class="col-md-2" style="margin-top: 19px;padding: 0px;">
												<?php $value = (isset($sale_return) ? $sale_return->accounts->city_name : ''); ?>
												<input type="text" name="account_city" readonly id="account_city" class="form-control" value="<?php echo $value; ?>">
										...
										<div class="row">
											<div class="col-md-4" style="padding-right: 0px;">
												<?php $value = (isset($sale_return) ? $sale_return->AccountID2 : ''); ?>
												
												<!--<div class="form-group">
													<label for="shipping_party">Ship To Party</label>
													<input type="text" name="shipping_party" readonly id="shipping_party" class="form-control" value="<?php echo $value; ?>" >
												</div>-->
												<div class="form-group">
													<label for="shipping_party" class="control-lable">Ship To Party</label>
													<select name="shipping_party" id="shipping_party" class="selectpicker form-control" data-none-selected-text="None selected" data-live-search="true">
														<option value="">None selected</option>
														<?php
															foreach($PartyList as $key=>$val){
															?>
											...
											<div class="col-md-7" style="padding-right: 0px;">
												<?php $value = (isset($sale_return) ? $sale_return->Address : ''); ?>
												
												<!--<div class="form-group">
													<label for="shipping_address">Shipping Address</label>
													<input type="text" name="shipping_address" readonly id="shipping_address" class="form-control" value="<?php echo $value; ?>" >
												</div>-->
												<div class="form-group">
													<label for="shipping_address">Shipping Address</label>
													<select name="shipping_address" id="shipping_address" class="selectpicker form-control" data-none-selected-text="None selected" data-live-search="true">
														<option value="">None selected</option>
														<?php
															if(isset($sale_return)){
																$value = $sale_return->AccountID2_address;
									...
									<div class="col-md-4">
										<div class="row">
											<div class="col-md-12" style="margin-top: 2%;">
												<input type="radio" id="fresh" name="type_select" value="fresh" <?php if(isset($sale_return) && $sale_return->SalesRtnTypeID  == "Fresh"){ echo "checked"; } ?>>
												<label for="fresh">Add return to stock</label><br>
												<input type="radio" id="damage" name="type_select" value="damage" <?php if(isset($sale_return) && $sale_return->SalesRtnTypeID  == "Damage"){ echo "checked";} if(!isset($sale_return)){ echo "checked"; }?>>
										...
										<div class="row">
											<div class="col-md-12" style="margin-top: 8%;height: 97px;">
												...
												<?php $value = (isset($sale_return) ? $sale_return->BT : ''); ?>
												<input type="hidden" value="<?php echo $value; ?>" name="is_taxable" id="is_taxable">
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row">
								...
								<table class="table table-striped table-bordered" id="data_table" width="100%">
									<thead>
										<tr>
											...
											<th style="width:5%">ReturnQty(loose)</th>
											<th style="width:5%">BasicRate(loose)</th>
									...
									<tbody id="tbody">
										<?php
											...
											<?php 
												...
												$AllTotalBilledCSNew += $billedCS_new;
												$AllTotalBilledQtyNew += $value["BilledQty"];
											?>
											<tr id='row<?php echo $i;?>'>
												...
												<td id='billed_cs<?php echo $i;?>' align='right'><?php echo number_format($billedCS_new, 2, '.', ''); ?><input type='hidden' name='billed_cs_val<?php echo $i;?>' value='<?php echo number_format($billedCS_new, 2, '.', ''); ?>'></td>
							...
							<div class="col-md-6">
								<table class="table text-right">
									<tr id="subtotal">
										<td><span class="bold">Total Billed CS :</span></td>
										<td id="TotalBillesCS"><?php echo number_format($AllTotalBilledCSNew, 2, '.', ''); ?></td>
										<td><span class="bold">Total Return Qty(loose) :</span>
										</td>
										<td id="TotalReturnQty"><?php echo number_format($AllTotalBilledQtyNew, 2, '.', ''); ?></td>
									</tr>
							...
							<div class="col-md-6">
								<table class="table text-right">
									...
									<tr>
										<td>Disc Amt</td>
										<?php $value = (isset($sale_return) ? $sale_return->DiscAmt : '0.00'); ?>
										<td width="30%"><span id="disc_total"><?php echo $value; ?></span><input type="hidden" name="disc_total_val" id="disc_total_val" value="<?php echo $value; ?>"></td>
									</tr>
									<tr>
										<td>CGST Amt</td>
										<?php $value = (isset($sale_return) ? $sale_return->cgstamt : '0.00'); ?>
									...
									<tr>
										<td>Round OFF</td>
										<?php $value = (isset($sale_return) ? $sale_return->RndOffAmt : '0.00'); ?>
										<td  width="30%"><span id="roundoff_total"><?php echo $value; ?></span><input type="hidden" name="roundoff_total_val" id="roundoff_total_val" value="<?php echo $value; ?>"></td>
									</tr>
									<tr>
										<td>Net Amt</td>
										<?php $value = (isset($sale_return) ? $sale_return->RndAmt : '0.00'); ?>
							...
							<div class="col-md-12 btn-bottom-toolbar text-right">
								<div class="row">
									<?php 
										if(isset($sale_return)){
										?>
										...
										<?php if($return == "disabled"){ ?>
											...
											<?php }else{ ?>
											<button type="submit"  class="btn btn-info" id="submit_form" >Update</button>
										<?php } ?>
										
										<?php } ?>
										<?php }else{ ?>
										<?php if(has_permission_new('sale_return','','create')){ ?>
											<button type="submit" class="btn btn-info" id="submit_form" ><?php echo _l('submit'); ?></button>
										<?php } ?>
									<?php } ?>
									...
									<?php if(has_permission_new('sale_return','','view')){ ?>
										<a href="#" class="btn btn-warning add-new-transfer">show list</a>
									<?php } ?>
					...
					<div class="col-md-12">
						<div class="table_salertn_report">
							<table class="tree table table-striped table-bordered table_salertn_report" id="table_salertn_report" width="100%">
								<thead>
									<tr>
										<th class="sortablePop" style="width:8%;">SalesRtnID</th>
										<th class="sortablePop" style="width:15%;text-align:left;">ReturnDate</th>
										<th class="sortablePop" style="width:5%;text-align:center;">AccountID</th>
										<th class="sortablePop" style="width:20%;text-align:left;">Account Name</th>
										<th class="sortablePop" style="width:20%;text-align:left;">Address</th>
										<th class="sortablePop" style="width:3%;text-align:center;">SaleAmt</th>
										<th class="sortablePop" style="width:3%;text-align:right;">DiscAmt</th>
										<th class="sortablePop" style="width:3%;text-align:right;">CGSTAmt</th>
										<th class="sortablePop" style="width:3%;text-align:right;">SGSTAmt</th>
										<th class="sortablePop" style="width:3%;text-align:right;">IGSTAmt</th>
										<th class="sortablePop" style="width:3%;text-align:right;">BillAmt</th>
										<th class="sortablePop" style="width:3%;text-align:right;">Items</th>
									</tr>
								</thead>
								<tbody>
									<?php
...
<script type="text/javascript">
	function CalculateTotalValues() {
		let AllTotalBilledCS = 0;
		let AllTotalReturnQty = 0;
		...
		$('#tbody tr').each(function () {
			...
			// 6th column (index 5)
			let col6 = parseFloat($(this).find('td:eq(5)').text()) || 0;
			
			// 7th column (index 6)
			let col7 = parseFloat($(this).find('td:eq(6)').text()) || 0;
			
			AllTotalBilledCS += col6;
			AllTotalReturnQty += col7;
		});
		
		$('#TotalBillesCS').html(AllTotalBilledCS);
		$('#TotalReturnQty').html(AllTotalReturnQty);
...
<script type='text/javascript'>
	...
	$(document).ready(function () {
		...
		$('#tbody').on('click', '.remove', function () {
			...
			var disc_total = $("#disc_total_val").val();
			var cgst_total = $("#cgst_total_val").val();
			var sgst_total = $("#sgst_total_val").val();
			var igst_total = $("#igst_total_val").val();
			var net_total1 = $("#net_total_val").val();
			var roundoff_total_val = $("#roundoff_total_val").val();
			net_total = parseFloat(net_total1)+parseFloat(roundoff_total_val);
			var act_state = $("#account_state").val();
			var total_amt =$(this).parents("tr").find('input[name="total_amt_val'+no+'"]').val();
			var disc_amt =$(this).parents("tr").find('input[name="disc_amt_val'+no+'"]').val();
			...
			gross_total = parseFloat(gross_total) - parseFloat(disc_amt) - parseFloat(sale_total);
			$('#gross_total').html(parseFloat(gross_total).toFixed(2));
			$('#gross_total_val').val(parseFloat(gross_total).toFixed(2));
			
			disc_total_new = parseFloat(disc_total) - parseFloat(disc_amt);
			$('#disc_total').html(parseFloat(disc_total_new).toFixed(2));
			$('#disc_total_val').val(parseFloat(disc_total_new).toFixed(2));
			
			net_total = parseFloat(net_total) - parseFloat(total_amt);
			
			net_total_round = Math.round(parseFloat(net_total));
			RoundOffAmt = parseFloat(net_total) - parseFloat(net_total_round);
			$('#roundoff_total').html(RoundOffAmt.toFixed(2));
			$('#roundoff_total_val').val(RoundOffAmt.toFixed(2));
			
			$('#net_total').html(Math.round(parseFloat(net_total)).toFixed(2));
			$('#net_total_val').val(Math.round(parseFloat(net_total)).toFixed(2));
		...
		$("body").on("click", ".btn-update", function(){ 
			...
			if(return_qty == "" || return_qty == null || order_qty == "" || order_qty == null){
				...
				if(return_qty > order_qty){
					...
					var old_disc_amt_val = $(this).parents("tr").find('input[name="disc_amt_val'+num+'"]').val();
					
					disc_total = disc_total - old_disc_amt_val;
					var disc_per_val = $(this).parents("tr").find('input[name="disc_per_val'+num+'"]').val();
					var value = parseFloat(basic_rate) * return_qty
					var disc_amt_val = ((parseFloat(value) * disc_per_val)/100);
					var pamt = parseFloat(value) - disc_amt_val;
					
					
					
					$(this).parents("tr").find("td:eq(9)").html('<span>'+disc_amt_val+'</span><input type="hidden" name="disc_amt_val'+num+'" id="disc_amt_val'+num+'" value="'+disc_amt_val+'">');
                    ...
                    var new_disc = disc_total + parseFloat(disc_amt_val);
                    var new_gross = net_total + parseFloat(new_disc) - new_gst;
                    // var new_gross = net_total + parseFloat(disc_amt_val) - new_gst;
					
                    $('#gross_total').html(parseFloat(new_gross).toFixed(2));
                    $('#gross_total_val').val(parseFloat(new_gross).toFixed(2));
					
					
                    $('#disc_total').html(parseFloat(new_disc).toFixed(2));
                    $('#disc_total_val').val(parseFloat(new_disc).toFixed(2));
	...
	$(document).ready(function(){
		...
		$( "#act_name" ).autocomplete({
			...
			select: function (event, ui) {
				...
				if(empty(old_AccountID)){
					...
					$('#account_city').val(ui.item.city_name);
					...
					$.ajax({
						...
						success: function( data ) {
							if(empty(data)){
								...
								$('#account_city').val(data.city_name); 
								...
								$("#item_code").focus();
								$('#shipping_party').val(data.AccountID);
								$('.selectpicker').selectpicker('refresh');
								$('#shipping_party').change();
							}
						}
					});
				}
						...
						$.ajax({
							...
							success: function( data ) {
								if(empty(data)){
									...
									$('#account_city').val(data.city_name); // display the selected text
		...
		$('#shipping_party').on('change', function() {
			var ShipToParty = $(this).val();
			
			var old_AccountID = $('#old_act_name2').val();
			var BillToParty = $("#act_name").val();
			if(empty(old_AccountID)){
				$("#shipping_address").children().remove();
					...
					jQuery.ajax({
						...
						success: function(data) {
							...
							for (var i = 0; i < ShippingAddress.length; i++) {
								...
								$("#shipping_address").append('<option value="'+ShippingAddress[i]["id"]+'">'+leble+'</option>');
							}
							$('.selectpicker').selectpicker('refresh');
						}
					});
				...
				if(old_AccountID == ShipToParty){
					...
					if(Conform == true){
						...
						$('#shipping_party').val(old_AccountID);
						$('.selectpicker').selectpicker('refresh');
					}
				}
			}
		...
		$( "#item_code" ).autocomplete({
			...
			source: function( request, response ) {
				...
				var shipping_party = $("#shipping_party").val(); 
				if(act_code && shipping_party){
					$.ajax({
			...
			select: function (event, ui) {
				...
				if(sale_item_array.includes(ui.item.value)){
					...
					$("#item_code").blur();
					// init_model(ui.item.value,act_code,shipping_party);
					// $('#sales_item_modal').on('shown.bs.modal', function () {
					// $('#myInput3').focus();
					// })
					return false;  
					}else{
					alert("item not sale to this party");
					$("#item_code").val('');
					$('#item_name').html('');
					$('#item_name_val').val('');
					$('#pack').html(''); 
		...
		$('#item_code').on('blur', function () {
			...
			if(ItemID !== ''){
				$.ajax({
					...
					dataType: "json",
					data: {
						ItemID: ItemID,act_code:act_code,shipping_party:shipping_party
					},
					success: function( data ) {
						if(data == null){
							...
							if(sale_item_array.includes(data.item_code)){
								...
								init_model(data.item_code,act_code,shipping_party);
								$('#sales_item_modal').on('shown.bs.modal', function () {
									$('#myInput3').focus();
								})
								// }else{
								// get_bill_details(data.BillID);
								// }
								return false; 
								}else{
								alert("item not sale to this party");
		...
		$('#return_qty').on('blur', function () {
			...
			if(return_qty == "" || return_qty == null || order_qty == "" || order_qty == null){
				...
				if(return_qty > order_qty){
					...
					var disc_per_val = $("#disc_per_val").val();
					var value = parseFloat(basic_rate) * return_qty
					var disc_amt_val = ((parseFloat(value) * disc_per_val)/100);
					var pamt = parseFloat(value) - disc_amt_val;
					$('#discamt').html(parseFloat(disc_amt_val).toFixed(2));
					$('#disc_amt_val').val(parseFloat(disc_amt_val).toFixed(2));
					if(act_state == "UP"){
		...
		function init_model(item_code,act_code,shipping_party)
		{	
			...
			if (typeof (item_code) !== 'undefined') {
				...
				requestGetJSON('sale_return/get_bill_id/' + item_code +"/"+ act_code +"/"+ shipping_party).done(function (response) {
					if(response == "" || response == null){
						...
						$.each(response, function (column, value) {
							html +='<tr onclick="get_bill_details(\''+value.TransID+'\',\''+value.id+'\')">';
...
<script>
	...
	//========================== Get Bill Items Details ============================
    function get_bill_details(bill_id,incId)
    {
        ...
        var is_taxable = $("#is_taxable").val();
        var cases = '';
		requestGetJSON('sale_return/BillItemDetailsByID/'+ bill_id+'/'+item_code+'/'+incId).done(function (response) {
			if(added_trn_id == bill_id && is_taxable == 'T' || added_trn_id == "" || added_trn_id == null || is_taxable == "" || is_taxable == null || is_taxable == "B" && response.BT == "B"){
                ...
                $data_table.find('input[name="billed_cs_val"]').val(cases.toFixed(2));
                ...
                $data_table.find('#billed_cs').html(cases.toFixed(2));
                ...
                $('#is_taxable').val(response.BT);
                $('#SaleID').val(response.TransID);
                $('#sales_item_modal').modal('hide');
                $data_table.find('input[name="return_qty"]').focus();
				
				// $('#shipping_party').val(response.shipto.ShipToParty);
				// $('#shipping_address').val(response.shipto.Address);
                return true;
				}else{
				$('#sales_item_modal').modal('hide');
...
<script>
    function add_row()
	{
		...
		gross_total = parseFloat(gross_total) + parseFloat(disc_amt_val) + parseFloat(sale_total);
		$('#gross_total').html(parseFloat(gross_total).toFixed(2));
		$('#gross_total_val').val(parseFloat(gross_total).toFixed(2));
		
		disc_total_new = parseFloat(disc_total) + parseFloat(disc_amt_val);
		$('#disc_total').html(parseFloat(disc_total_new).toFixed(2));
		$('#disc_total_val').val(parseFloat(disc_total_new).toFixed(2));
...
<script>
	...
	$(document).on("click", ".sortablePop", function () {
		var table = $("#table_salertn_report tbody");
