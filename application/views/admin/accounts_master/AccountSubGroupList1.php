          ...
          <div class="panel-body">
           <nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Account SubGroup 1 List</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
            <div class="row">
               <!-- <div class="col-md-12">
                    <h4 class="no-margin font-bold">Account SubGroup 1 List</h4>
                    <hr>
                </div>-->
            ...
            <div class="tableFixHead2">
                ...
                <tr>
                    <th  class="sortable">Account SubGroupID 1</th>
                    <th class="sortable">Account SubGroup Name 1</th>
...
<script>
    $('#search_data').on('click',function(){
	    ...
	    $.ajax({
            url:"<?php echo admin_url(); ?>accounts_master/load_subgroup1_data",
            dataType:"json",
            method:"POST",
    ...
    $("#caexcel").click(function(){
        var main_group = $("#main_group").val();
        $.ajax({
            url:"<?php echo admin_url(); ?>accounts_master/ExportAccount_sub_groupList1",
            method:"POST",
            data:{main_group:main_group},
            success:function(data){
 ...
 function printPage(){
    ...
    var tableData = '<table  border="1" cellpadding="0" cellspacing="0" width="100%" class="tree table table-striped table-bordered" style="font-size:12px;">'+document.getElementsByTagName('table')[0].innerHTML+'</table>';
        var heading_data = '<table  border="1" cellpadding="0" cellspacing="0" width="100%" class="tree table table-striped table-bordered" style="font-size:12px;"><tbody><tr><td style="text-align:center;" colspan="3"><?php echo $company_detail->company_name; ?></td></tr><tr><td style="text-align:center;" colspan="3"><?php echo $company_detail->address; ?></td></tr>';
         heading_data += '<tr>';
         heading_data += '<td style="text-align:center;"colspan="3">Account SubGroup List 1</td>';
         heading_data += '</tr>';
