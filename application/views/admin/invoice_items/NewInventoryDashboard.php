							        ...
							        <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 ">
        								...
        								<div class="top_stats_wrapper custdesg bg1">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="StockOutRateSpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>
									...
									<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 <?php echo $initial_column; ?>">
        								...
        								<div class="top_stats_wrapper custdesg bg2">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="OutOfStockCountSpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>

        										<p class="mtop5 labeltxt" id="OutOfStockCount"></p>

        										<p class="title"><?php echo _l('Out of Stock SKU Count'); ?></p>
									...
									<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 <?php echo $initial_column; ?>">
        								...
        								<div class="top_stats_wrapper custdesg bg2">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="LowStockCountSpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>

        										<p class="mtop5 labeltxt" id="LowStockCount"></p>

        										<p class="title"><?php echo _l('Low Stock SKU Count'); ?></p>
									...
									<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 <?php echo $initial_column; ?>">
        								...
        								<div class="top_stats_wrapper custdesg bg2">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="InvTurnOverRatioSpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>

        										<p class="mtop5 labeltxt" id="InvTurnOverRatio"></p>

        										<p class="title"><?php echo _l('Inventory Turnover Ratio'); ?></p>
									...
									<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 <?php echo $initial_column; ?>">
        								...
        								<div class="top_stats_wrapper custdesg bg2">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="DaysInvOutstandingSpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>

        										<p class="mtop5 labeltxt" id="DaysInvOutstanding"></p>

        										<p class="title"><?php echo _l("Day's Inventory Outstanding"); ?></p>
									...
									<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 <?php echo $initial_column; ?>">
        								...
        								<div class="top_stats_wrapper custdesg bg2">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="TotalIssueStockAmtSpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>

        										<p class="mtop5 labeltxt" id="TotalIssueStockAmt"></p>

        										<p class="title"><?php echo _l('Issue Stock Amt'); ?></p>
									...
									<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 ">
        								...
        								<div class="top_stats_wrapper custdesg bg1">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="TotalIssueStockQtySpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>

        										<p class="mtop5 labeltxt" id="TotalIssueStockQty"></p>

        										<p class="title"><?php echo _l('Issue Stock Qty'); ?></p>
									...
									<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 ">
        								...
        								<div class="top_stats_wrapper custdesg bg1">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="TotalRMStockAmtSpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>

        										<p class="mtop5 labeltxt" id="TotalRMStockAmt"></p>

        										<p class="title"><?php echo _l('RM Stock Amt'); ?></p>
									...
									<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 ">
        								...
        								<div class="top_stats_wrapper custdesg bg1">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="TotalPMStockAmtSpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>

        										<p class="mtop5 labeltxt" id="TotalPMStockAmt"></p>

        										<p class="title"><?php echo _l('PM Stock Amt'); ?></p>
									...
									<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 ">
        								...
        								<div class="top_stats_wrapper custdesg bg1">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="TotalFGStockAmtSpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>

        										<p class="mtop5 labeltxt" id="TotalFGStockAmt"></p>

        										<p class="title"><?php echo _l('FG Stock Amt'); ?></p>
									...
									<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 ">
        								...
        								<div class="top_stats_wrapper custdesg bg1">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="HighestOrderItemSpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>

        										<p class="mtop5 labeltxtItem" id="HighestOrderItem"></p>

        										<p class="title"><?php echo _l('Highest Ordered (Qty)'); ?></p>
									...
									<!--<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 <?php echo $initial_column; ?>">
        								...
        								<div class="top_stats_wrapper custdesg bg2">
        									...
        									<div class="col-md-12">
        									    ...
        									    <p class="DeadStockCountSpinner mtop5 labeltxt" style="display: none;"><i class="fa fa-spinner fa-spin"></i></p>
							        ...
							        <div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 ">
        								...
        								<div class="top_stats_wrapper custdesg bg1">
        									...
        									<div class="col-md-12">
        										...
        										<p class="title"><?php echo _l('Stock Issued'); ?></p>
									...
									<div class="quick-stats-invoices col-xs-12 col-md-3 col-sm-3 ">
        								...
        								<div class="top_stats_wrapper custdesg bg2">
        									...
        									<div class="col-md-12">
        										...
        										<p class="title"><?php echo _l('Stock Received Qty'); ?></p>
...

		{
			...
			$.ajax({
				...
				beforeSend: function () {
				    ...
				    $('.StockOutRateSpinner').show();

				    $('#StockOutRate').hide();

				    $('.OutOfStockCountSpinner').show();

				    $('#OutOfStockCount').hide();

				    $('.LowStockCountSpinner').show();

				    $('#LowStockCount').hide();

				    $('.InvTurnOverRatioSpinner').show();

				    $('#InvTurnOverRatio').hide();

				    $('.DaysInvOutstandingSpinner').show();

				    $('#DaysInvOutstanding').hide();

				    $('.TotalRMStockAmtSpinner').show();

				    $('#TotalRMStockAmt').hide();

				    $('.TotalPMStockAmtSpinner').show();

				    $('#TotalPMStockAmt').hide();

				    $('.TotalFGStockAmtSpinner').show();

				    $('#TotalFGStockAmt').hide();

				    $('.TotalIssueStockAmtSpinner').show();

				    $('#TotalIssueStockAmt').hide();

				    $('.TotalIssueStockQtySpinner').show();

				    $('#TotalIssueStockQty').hide();

				    $('.HighestOrderItemSpinner').show();

				    $('#HighestOrderItem').hide();

				    /*$('.DeadStockCountSpinner').show();
				...
				complete: function () {
				    ...
				    $('.StockOutRateSpinner').hide();

				    $('#StockOutRate').show();

				    $('.OutOfStockCountSpinner').hide();

				    $('#OutOfStockCount').show();

				    $('.LowStockCountSpinner').hide();

				    $('#LowStockCount').show();

				    $('.InvTurnOverRatioSpinner').hide();

				    $('#InvTurnOverRatio').show();

				    $('.DaysInvOutstandingSpinner').hide();

				    $('#DaysInvOutstanding').show();

				    $('.TotalRMStockAmtSpinner').hide();

				    $('#TotalRMStockAmt').show();

				    $('.TotalPMStockAmtSpinner').hide();

				    $('#TotalPMStockAmt').show();

				    $('.TotalFGStockAmtSpinner').hide();

				    $('#TotalFGStockAmt').show();

				    $('.TotalIssueStockAmtSpinner').hide();

				    $('#TotalIssueStockAmt').show();

				    $('.TotalIssueStockQtySpinner').hide();

				    $('#TotalIssueStockQty').show();

				    $('.HighestOrderItemSpinner').hide();

				    $('#HighestOrderItem').show();

				    /*$('.DeadStockCountSpinner').hide();
				...
				success:function(returndata){
					...
					var TotalRMStockAmt = returndata.TotalRMStockAmt;

					var TotalPMStockAmt = returndata.TotalPMStockAmt;

					var TotalFGStockAmt = returndata.TotalFGStockAmt;

					var TotalIssueStockQty = returndata.TotalIssueStockQty;

					var TotalIssueStockAmt = returndata.TotalIssueStockAmt;
					...
					*/
					...
					$("#OutOfStockCount").html(OutOfStockSKU ?? "0");

					$("#LowStockCount").html(LowStockSKU ?? "0");

					$("#HighestOrderItem").html(HighestOrderItem ?? "");

					$("#TotalRMStockAmt").html(TotalRMStockAmt ?? "0");

					$("#TotalPMStockAmt").html(TotalPMStockAmt ?? "0");

					$("#TotalFGStockAmt").html(TotalFGStockAmt ?? "0");

					$("#TotalIssueStockAmt").html(TotalIssueStockAmt ?? "0");

					$("#TotalIssueStockQty").html(TotalIssueStockQty ?? "0");
