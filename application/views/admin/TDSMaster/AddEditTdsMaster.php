        ...
        <div class="panel_s">
          <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <br>
                   <div class="col-md-2">
						<label class="control-label" for="TDSCode">TDS Code</label>
						<input type="text" id="TDSCode" name="TDSCode" class="form-control" value="">
						<span id="lblError" style="color: red"></span>
					</div>
                    <div class="col-md-4">
                        <label class="control-label" for="TDSName">TDS Name</label>
                    ...
                    <div class="col-md-3">
                        <label class="control-label" for="ThresholdLimit">Threshold Limit</label>
                        <input type="text" id="ThresholdLimit" name="ThresholdLimit" class="form-control" value="">
                        <span id="lblError" style="color: red"></span>
                    </div>
                    ...
                    <div class="col-md-8" style="margin-top:1%;">
                        <table class="table items table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th width="30%">TDS Sub Name</th>
                                    <th width="15%">Rate (%)<span id="lblErrorRate" style="color: red"></span></th>
                                    <th width="5%">&nbsp;</th>
                                </tr>
                            </thead>
                                <tbody id="parameter_body">
                                    <tr>
                                        <td width="30%"><input id="Description" class="form-control" name="Description" type="text" value=""></td>
                                        <td width="15%"><input id="rate" class="form-control numbers-only" name="rate" value=""></td>
                            ...
                            $.ajax({
								...
								success:function(res){
									init_selectpicker();
									   ...
									   $('#ThresholdLimit').val(res.ThresholdLimit);
									   $('select[name=isactive]').val(res.Blocked).selectpicker('refresh');
									   
										let TDSRateList = res.Details;
										//alert(TDSRateList.length);
										for(var count = 0; count < TDSRateList.length; count++)
											{	
												...
												markup += "<td><input type='text' name='TDSRate[]' id='TDSRate"+newcount+"' value='"+TDSRate+"' class='form-control '></td>";
												markup += "<td></td></tr>";
   ...
   $("#parameter_body").on('click','.removebtn',function(){
	...
	function add_row(){
		...
		if(TDSSubName != '' && TDSRate !=''){
			...
			markup = "<tr class='addedtr'>";
			markup += "<td><input name='TDSName[]' id ='TDSSubName' value='"+TDSSubName+"' class='form-control'></td>";
			markup += "<td><input name='TDSRate[]' value='"+TDSRate+"' class='form-control numbers-only'></td>";
	...
	// Empty and open create mode
        ...
        if(TDSCode == ''){
            ...
            $.ajax({
                ...
                dataType:"JSON",
                method:"POST",
                data:{TDSCode:TDSCode,isactive:isactive,ThresholdLimit:ThresholdLimit,
