        ...
        <!-- <div class="col-md-3">
            <div class="panel_s mbot5">
               <div class="panel-body padding-10">
                  <h4 class="bold">
                     #<?php echo $client->AccountID . ' ' . $title; ?>
                     ...
                     <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                           <?php if(is_admin()){ ?>
                           <li>
                              <a href="<?php echo admin_url('clients/login_as_client/'.$client->AccountID); ?>" target="_blank">
                           ...
                           <li>
                              <a href="<?php echo admin_url('clients/delete/'.$client->AccountID); ?>" class="text-danger delete-text _delete"><i class="fa fa-remove"></i> <?php echo _l('delete'); ?>
                              </a>
                           </li>
                           <?php } ?>
                        </ul>
         ...
         <div class="col-md-<?php if(isset($client)){echo 12;} else {echo 12;} ?>">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <?php echo form_hidden('userid', $client->AccountID); ?>
...
<script>
   $(function(){
      init_rel_tasks_table(<?php echo $client->AccountID; ?>,'customer');
   });
</script>
<?php } ?>
