...
foreach ($rResult as $aRow) {
   ...
   // $row[] = '<div class="checkbox"><input type="checkbox" value="' . $aRow['id'] . '"><label></label></div>';
    ...
    $action = '<a href="#" data-toggle="modal" data-target="#sales_item_modal" data-id="' . $aRow['id'] . '"><i class="fa fa-pencil"></i></a>';
    $action .= ' | <a href="' . admin_url('invoice_items/delete/' . $aRow['id']) . '" class="text-danger _delete"><i class="fa fa-trash"></i></a>';
    $row[] = $action;
