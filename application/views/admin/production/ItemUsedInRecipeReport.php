					...
					<div class="panel-body">
						...
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Item Used In Recipe Report</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						
						<?php if(has_permission_new('ItemUsedInRecipeReport','','view')){ ?>
							<div class="_buttons">
								<div class="col-md-4">
							...
							<table class="tree table table-striped table-bordered table-daily_report tableFixHead2" id="table-daily_report" width="100%">
								...
								<thead>
									...
									<tr>
										...
										<th class="sortable" style="text-align:left;">Batch Size (Kg) In Flour Base</th>
										<th class="sortable" style="text-align:left;">Item Name</th>
										<th class="sortable" style="text-align:left;">Qty</th>
										<th class="sortable" style="text-align:left;">Unit</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
...
<script>
	$(document).ready(function(){
		...
		{
			$.ajax({
				url:"<?php echo admin_url(); ?>production/GetItemUsedRecipeList",
				dataType:"JSON",
				method:"POST",
				data:{ItemID},
				beforeSend: function () {
...
<script>
	...
	$("#caexcel").click(function(){
	    ...
	    $.ajax({
            url:"<?php echo admin_url(); ?>production/export_itemusedrecipeReport",
            method:"POST",
            data:{ItemID:ItemID},
...
<script type="text/javascript">
	function printPage(){
		...
		heading_data += '<tr>';
		heading_data += '<td style="text-align:center;"colspan="3">Item Used In Recipe Report</td>';
		heading_data += '</tr>';
