          ...
          <div class="panel-body">
           <nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Production Order Report</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
                ...
                <div class="modal-body" style="padding:0px 5px !important">
                    <div class="table-PRD_List tableFixHead2">
                        <table class="tree table table-striped table-bordered table-PRD_List tableFixHead2" id="table_PRD_List" width="100%">
                            <thead>
                                <tr>
                                    <th class="sortablePop">Production ID </th>
                                    <th class="sortablePop">Production Date</th>
                                    <th class="sortablePop" style="text-align:left;">Item ID</th>
                                    <th class="sortablePop" style="text-align:left;">Item Name</th>
                                    <th class="sortablePop">Production Qty</th>
                                    <th class="sortablePop">Production By</th>
...
$(document).on("click", ".sortablePop", function () {
		var table = $("#table_PRD_List tbody");
