...
<h5>Raw Materials</h5>
<table class="table table-striped table-bordered" id="data_table" width="70%">
	<thead>
		<tr>
			<!--<th>Id</th>-->
			<th>Item Code</th>
		...
		<?php
			...
			foreach ($result2 as $row1) {	
				...
				<tr>  
					...
					<td><input type="text" name="item_id[]<?php echo $i;?>" value="<?php echo $row1['item_id']; ?>" class="form-control" style="width: 100px;border-radius: 2px;height: 30px;" readonly></td>
