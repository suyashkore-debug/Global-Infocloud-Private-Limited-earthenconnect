        ...
        <div class="panel-body" style="padding-top:8px;">
			   ...
			   <nav aria-label="breadcrumb">
                    				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                    					...
                    					<li class="breadcrumb-item active" aria-current="page"><b>Special Discount</b></li>
                    				</ol>
                                </nav>
                                <hr class="hr_style">
                        ...
                        <div class="modal-body" style="padding:0px 5px !important">
                            ...
                            <div class="table-Disc_List tableFixHead2">
                                <table class="tree table table-striped table-bordered table-Disc_List tableFixHead2" id="Disc_List" width="100%">
                                    <thead>
                                        <tr>
                                            <th class="sortablePop" style="text-align:left;">DiscountID </th>
                                            <th class="sortablePop" style="text-align:left;">TransDate</th>
                                            <th class="sortablePop" style="text-align:left;">Disc. From</th>
                                            <th class="sortablePop" style="text-align:left;">Disc. To</th>
                                            <th class="sortablePop" style="text-align:left;">Disc.</th>
                                            <th class="sortablePop" style="text-align:left;">Disc. Amt</th>
                                            <th class="sortablePop" style="text-align:left;">State</th>
                                            <th class="sortablePop" style="text-align:left;">Loc Type</th>
