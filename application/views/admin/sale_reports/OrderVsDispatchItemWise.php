					...
					<div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Order Vs Dispatch Item Wise</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="_buttons">
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function(){
		...
		$('#search_data').on('click',function(){
			...
			$.ajax({
				url:"<?php echo admin_url(); ?>sale_reports/GetOrderVsDispatchItemWise",
				dataType:"JSON",
				method:"POST",
				cache: false,
    ...
    $("#caexcel").click(function(){
	    ...
	    var AccountID = $("#PartyList").val();
	    $.ajax({
            url:"<?php echo admin_url(); ?>sale_reports/GetOrderVsDispatchItemWiseExport",
            method:"POST",
            data:{from_date:from_date, to_date:to_date,states:states, client_type:client_type,staff_id:staff_id,AccountID:AccountID},
            beforeSend: function () {
