					...
					<div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Daily Sale Summary</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="_buttons">
						...
						<div class="table-daily_report">
							...
							<table class="tree table table-striped table-bordered table-daily_report" id="table-daily_report" width="100%">
								...
								<thead>
									...
									<tr>
										<th style="text-align:left;" class="fontsize sortable">SR.No</th>
										<th style="text-align:left;" class="fontsize sortable">Party Name</th>
										<th style="text-align:left;" class="fontsize sortable">Location Type</th>
										<th style="text-align:left;" class="fontsize sortable">Opening Balance</th>
										<th style="text-align:left;" class="fontsize sortable">Sale Amount</th>
										<th style="text-align:left;" class="fontsize sortable">Payment Amount</th>
										<th style="text-align:left;" class="fontsize sortable">Received Amount</th>
										<th style="text-align:left;" class="fontsize sortable">Journal Amount</th>
										<th style="text-align:left;" class="fontsize sortable">Sale Return Amount</th>
										<th style="text-align:left;" class="fontsize sortable">CD Note Amount</th>
										<th style="text-align:left;" class="fontsize sortable">Closing Balance</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function(){
		...
		{
			$.ajax({
				url:"<?php echo admin_url(); ?>sale_reports/load_data_daily_sale",
				//dataType:"JSON",
				method:"POST",
	...
	$("#caexcel").click(function(){
	    ...
	    $.ajax({
            url:"<?php echo admin_url(); ?>sale_reports/export_daily_sale_summary",
            method:"POST",
            data:{from_date:from_date},
            beforeSend: function () {
