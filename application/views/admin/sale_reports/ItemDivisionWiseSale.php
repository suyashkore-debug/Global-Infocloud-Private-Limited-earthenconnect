					...
					<div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Division Wise Sale Summary</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						...
						<div class="_buttons">
							...
							<div class="row">
								...
								<div class="col-md-7">
									<input type="text" id="myInput1" class="form-control" onkeyup="myFunction2()" placeholder="Search .." title="Type in a name" style="float: right;width: 60%;">
								</div>
							</div>
						...
						<div class="fixTableHead ItemDivisionWiseSale_report">
...
<?php init_tail(); ?>
<style>
    .ItemDivisionWiseSale_report { overflow: auto;max-height: 60vh;width:100%;position:relative;top: 0px; }
    .ItemDivisionWiseSale_report thead th { position: sticky; top: 0; z-index: 1; }
    .ItemDivisionWiseSale_report tbody th { position: sticky; left: 0; }
    
    /* Just common table stuff. Really. */
    .ItemDivisionWiseSale_report table  { border-collapse: collapse; width: 100%; }
    th, td { padding: 1px 5px !important; white-space: nowrap; border:1px solid !important;font-size:11px; line-height:1.42857143!important;vertical-align: middle !important;}
    .ItemDivisionWiseSale_report th     { background: #50607b;color: #fff !important; }
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function(){
		...
		$('#search_data').on('click',function(){
			...
			$.ajax({
				url:"<?php echo admin_url(); ?>sale_reports/GetItemDivisionWiseSaleReport",
				dataType:"JSON",
				method:"POST",
				cache: false,
				...
				beforeSend: function () {
					...
					$('.ItemDivisionWiseSale_report').css('display','none');
				},
				complete: function () {
					$('.ItemDivisionWiseSale_report').css('display','');
					$('#searchh').css('display','none');
				},
				success:function(data){
					$('.ItemDivisionWiseSale_report').html(data);
				}
			});
	...
	$("#caexcel").click(function(){
	    ...
	    var to_date = $("#to_date").val();
	    $.ajax({
			url:"<?php echo admin_url(); ?>sale_reports/ExportItemDivisionWiseSale",
			method:"POST",
			data:{from_date:from_date, to_date:to_date},
			beforeSend: function () {
...
<script type="text/javascript">
	function printPage(){
		...
		var colspan = '11';
		var AccountDetails = 'Item Division Wise Sale';
