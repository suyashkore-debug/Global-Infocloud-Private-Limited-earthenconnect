					...
					<div class="panel-body">
						...
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Trade Receivable Report</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="_buttons">
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function(){
		...
		$('#search_data').on('click',function(){
			...
			$.ajax({
				url:"<?php echo admin_url(); ?>sale_reports/GetBillsReceivableReport",
				dataType:"JSON",
				method:"POST",
				cache: false,
	...
	$("#caexcel").click(function(){
	    ...
	    $.ajax({
			url:"<?php echo admin_url(); ?>sale_reports/ExportBillsReceivableReport",
			method:"POST",
			data:{from_date:from_date, to_date:to_date,ReportType:ReportType},
			beforeSend: function () {
...
<script type="text/javascript">
	function printPage(){
		...
		var colspan = '11';
		var AccountDetails = 'Trade Receivable Report';
