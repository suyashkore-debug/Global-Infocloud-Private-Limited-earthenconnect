					...
					<div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>CD Report</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="_buttons">
							...
							<div class="row">
								...
								<div class="col-md-12" id="search_div" style="display:none">
									<input type="text" id="myInput1"  name="myInput1" onkeyup="myFunction1()" placeholder="Search for names.."  style="float: right;width: 25%;">
								</div>
							</div>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function(){
		...
		$('#search_data').on('click',function(){
			...
			var AccountID = $("#AccountID").val();
				...
				$.ajax({
					url:"<?php echo admin_url(); ?>sale_reports/GetCDReport",
					dataType:"JSON",
					method:"POST",
					cache: false,
	...
	$("#caexcel").click(function(){
	    ...
	    $.ajax({
			url:"<?php echo admin_url(); ?>sale_reports/ExportCDReport",
			method:"POST",
			data:{from_date:from_date, to_date:to_date, AccountID:AccountID,TransType:TransType,
			AccountName:AccountName,AccountAddress:AccountAddress,AccountAddress2:AccountAddress2,station:station,StateName:StateName},
			beforeSend: function () {
