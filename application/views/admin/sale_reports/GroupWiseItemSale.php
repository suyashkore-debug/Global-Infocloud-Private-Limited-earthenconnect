					...
					<div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Group Wise Item Sale</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="_buttons">
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function(){
		...
		$('#search_data').on('click',function(){
			...
			$.ajax({
				url:"<?php echo admin_url(); ?>sale_reports/GetItemGroupWiseItemSaleReport",
				dataType:"JSON",
				method:"POST",
				cache: false,
				...
				beforeSend: function () {
					...
					$('.GroupWiseItemSale_report').css('display','none');
				},
				complete: function () {
					$('.GroupWiseItemSale_report').css('display','');
					$('#searchh').css('display','none');
				},
				success:function(data){
					$('.GroupWiseItemSale_report').html(data);
				}
			});
	...
	$("#caexcel").click(function(){
	    ...
	    var to_date = $("#to_date").val();
	    $.ajax({
			url:"<?php echo admin_url(); ?>sale_reports/ExportGroupWiseItemSale",
			method:"POST",
			data:{from_date:from_date, to_date:to_date},
			beforeSend: function () {
...
<script type="text/javascript">
	function printPage(){
		...
		var colspan = '11';
		var AccountDetails = 'Group Wise Item Sale';
