				...
				<div class="panel_s">
					...
					<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Customer Performance Report</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="_buttons">
							<div class="row">  
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<select class="selectpicker" name="Route" id="Route" data-width="100%"  data-action-box="true"   data-hide-disabled="true" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
											<option value=""></option>
											<?php
							...
							<div class="table-daily_report">
								...
								<table class="tree table table-striped table-bordered table-daily_report" id="table-daily_report" width="100%">
									...
									<thead>
										...
										<tr>
											<th style="text-align:left;" class="sortable">Customer ID</th>
											<th style="text-align:left;" class="sortable">Customer Name</th>
											<th style="text-align:left;" class="sortable">Sale Amt</th>
											<th style="text-align:left;" class="sortable">Return Amt</th>
											<th style="text-align:left;" class="sortable">Payment Amt</th>
											<th style="text-align:left;" class="sortable">Balance Amt</th>
											<th style="text-align:left;" class="sortable">Open Crate</th>
											<th style="text-align:left;" class="sortable">Crate Out</th>
											<th style="text-align:left;" class="sortable">Crate In</th>
											<th style="text-align:left;" class="sortable">Balance Crate</th>
										</tr>
									</thead>
									<tbody id="tableBody">
									</tbody>
							...
							<div class="col-md-12">
								<div class="panel_s">
									<div class="panel-body" style="max-height: 600px;">
										<div class="row"> 
											<div class="col-md-12">
												<h4 style="text-align:center;"><b>Sales Summary</b></h4>
											</div>
											<div class="col-md-12">
...
<script type="text/javascript" language="javascript" >
	function GetSaleReport(AccountID)
	{
		
		var from_date = $("#from_date").val();
		var to_date = $("#to_date").val();
		$.ajax({
			url:"<?php echo admin_url(); ?>sale_reports/GetDailySaleReportsByAccountID",
			dataType:"JSON",
			method:"POST",
			data:{AccountID:AccountID,from_date:from_date,to_date:to_date},
			beforeSend: function () {
			},
			complete: function () {
			},
	...
	$(document).ready(function(){
		...
		function load_data(from_date,to_date,Route)
		{
			$.ajax({
				url:"<?php echo admin_url(); ?>sale_reports/GetCustPerformReport",
				dataType:"JSON",
				method:"POST",
				data:{from_date:from_date, to_date:to_date,Route:Route},
				beforeSend: function () {
		...
		$('#search_data').on('click',function(){
			...
			var to_date = $("#to_date").val();
			var Route = $("#Route").val();
			var msg = "Customer Performance Report "+from_date +" To " + to_date;
			$(".report_for").text(msg);
			load_data(from_date,to_date,Route);
	...
	$("#caexcel").click(function(){
	    ...
	    $.ajax({
            url:"<?php echo admin_url(); ?>sale_reports/export_customer_performance",
            method:"POST",
            data:{from_date:from_date, to_date:to_date,Route:Route},
            beforeSend: function () {
...
<script type="text/javascript">
	function printPage(){
		...
		heading_data += '<tr>';
		heading_data += '<td style="text-align:center;"colspan="9">Customer Performance Report : '+from_date+' To '+to_date+'</td>';
		heading_data += '</tr>';
