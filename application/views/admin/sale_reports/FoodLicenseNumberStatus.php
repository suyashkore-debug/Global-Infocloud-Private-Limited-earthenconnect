					...
					<div class="panel-body">
						...
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Food License Number Status</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="row">
							...
							<table class="tree table table-striped table-bordered table-daily_report" id="table-daily_report" width="100%">
								...
								<thead>
									...
									<tr>
										...
										<th class="sortable" style="text-align:left;">Customer Name</th>
										<th class="sortable" style="text-align:left;">Station Name</th>
										<th class="sortable" style="text-align:left;">FSSAI No</th>
										<th class="sortable" style="text-align:left;">FSSAI Date of Expiry</th>
										<th class="sortable" style="text-align:left;">Day Remain</th>
									</tr>
								</thead>
								<tbody>
									<?php
										...
										{
											if(!empty($client['FLNO1'])){
											// Today's date
											$today = new DateTime();
											
											// Date you want to calculate the remaining days until (31/01/2025)
											$targetDate = DateTime::createFromFormat('d/m/Y', _d(substr($client['expiry_licence'],0,10)));
											...
											if($remainingDays <= 0)
											{
											$css = "style='background-color:red; color:#fff;'";
											}
											else
											{
												$css = "";
										...
										?>
										<tr <?= $css?> >
											<td style="text-align:left;"><?= $i;?></th>
											<td style="text-align:left;"><?= $client['company'].' - ('.$client['AccountID'].')'?></td>
											<td style="text-align:left;"><?= $client['StationName']?></td>
											<td style="text-align:left;"><?= $client['FLNO1']?></td>
											<td style="text-align:left;"><?= _d(substr($client['expiry_licence'],0,10))?></td>
											<td style="text-align:left;"><?= $remainingDays?></td>
										</tr>
										<?php
											$i++;
											}
...
<script type="text/javascript" language="javascript" >
	...
	$("#caexcel").click(function(){
	    ...
	    $.ajax({
            url:"<?php echo admin_url(); ?>sale_reports/export_food_license_status",
            method:"POST",
...
<script type="text/javascript">
	function printPage(){
		...
		heading_data += '<tr>';
		heading_data += '<td style="text-align:center;"colspan="9">Food License Number Status</td>';
		heading_data += '</tr>';
