				...
				<div class="panel_s accounting-template estimate">
									...
									<div role="tabpanel" class="tab-pane active" id="general_infor">
										<div class="row">
											...
											<div class="col-md-2">
												...
												echo render_date_input('TransDate','Applicable From Date',$order_date,$attribute); ?>
												
											</div>
											
											<div class="col-md-2">
												<label for="customer"><?php echo _l('Customer.'); ?></label>
												<select name="customer" id="customer" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo "Non selected" ?>" >
											...
											<div class="col-md-2">
												...
												<select onchange="GetApplicableType(this.value)" name="applicable_on"  id="applicable_on" class="selectpicker" data-live-search="true" data-width="100%"  >
													<option value="Group">Group</option>
													<option value="Item">Item</option>
												</select>  
											</div>
											<div class="col-md-2" id="Group_div" style="display:none;">
												<label for="applicable_on">Item Group</label>
												<select name="applicable_on"  id="applicable_on" class="selectpicker" data-live-search="true" data-width="100%"  >
												</select>  
											</div>
										</div>
										<div class="row">
					...
					<div class="panel-body mtop10">
						<div class="row col-md-12">
							<p class="bold p_style"><?php echo "Vehicle Inspection Check List" ?></p>
							<hr class="hr_style"/>
...
<script>
	function GetApplicableType(value){
		if(value == 'Item'){
			$('#Group_div').show();
			}else{
			$('#Group_div').hide();
