					...
					<div class="panel-body">
						...
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Final Vehicle Report</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="_buttons">
							...
							<table class="tree table table-striped table-bordered table-daily_report" id="table-daily_report" width="100%">
								...
								<thead>
									...
									<tr>
										...
										<th class="sortable" style="text-align:left;">Party Name </th>
										<th class="sortable" style="text-align:left;">Expected Delivery Time</th>
										<th class="sortable" style="text-align:left;">Route</th>
										<th class="sortable" style="text-align:left;">Vehicle Type</th>
										...
										<th class="sortable" style="text-align:left;">Challan No.</th>
										<th class="sortable" style="text-align:left;">Bill Amount</th>
										<th class="sortable" style="text-align:left;">Out DateTime</th>
										<th class="sortable" style="text-align:left;">In DateTime</th>
										<th class="sortable" style="text-align:left;">Out Crate Qty</th>
										<th class="sortable" style="text-align:left;">In Crate Qty</th>
										<th class="sortable" style="text-align:left;">Out Meater Reading</th>
										<th class="sortable" style="text-align:left;">In Meater Reading</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
...
<script type="text/javascript">
	function printPage(){
		...
		heading_data += '<tr>';
		heading_data += '<td style="text-align:center;"colspan="9">Final Vehicle Report From : '+from_date+' To '+to_date+'</td>';
		heading_data += '</tr>';
