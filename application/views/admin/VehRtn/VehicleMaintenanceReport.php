					...
					<div class="panel-body">
						...
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Vehicle Maintenance Report</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="_buttons">
							...
							<table class="tree table table-striped table-bordered table-daily_report" id="table-daily_report" width="100%">
								...
								<thead>
									...
									<tr>
										...
										<th class="sortable" style="text-align:left;">Vehicle Number</th>
										<th class="sortable" style="text-align:left;">Driver Name</th>
										<th class="sortable" style="text-align:left;">Remark</th>
										<th class="sortable" style="text-align:left;">Cost</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function(){
		...
		{
			$.ajax({
				url:"<?php echo admin_url(); ?>VehRtn/LoadVehicleMaintenanceReport",
				dataType:"JSON",
				method:"POST",
	...
	$("#caexcel").click(function(){
		...
		$.ajax({
			url:"<?php echo admin_url(); ?>VehRtn/export_VehicleMaintenanceReport",
			method:"POST",
			data:{from_date:from_date, to_date:to_date},
			beforeSend: function () {
