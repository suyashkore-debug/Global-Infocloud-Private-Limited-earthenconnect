                    ...
                    <div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Vehicle Return Crates</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
                        <div class="row">
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="padding:5px;">
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							<label class="control-label">Crate Status</label>
							...
							<table class="tree table table-striped table-bordered table_vehicle_return" id="table_vehicle_return" width="100%">
								...
								<thead>
									<tr >
										...
										<th class="sortablePop" style=" text-align:center;">Station</th>
...
<script>
	$("#search_data_vehicle_return").click(function(){ 
        ...
        $.ajax({
			url:"<?php echo admin_url(); ?>VehRtn/vehicle_return_model_crates",
			dataType:"html",
			method:"POST",
			data:{from_date:from_date,to_date:to_date,IsCrate:IsCrate},
			beforeSend: function () {
