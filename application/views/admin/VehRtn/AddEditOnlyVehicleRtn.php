						...
						<div class="row">
							<div class="col-md-12 mtop15">
								<div class="btn-bottom-toolbar text-right" style="width: 100%;">
									<?php if (has_permission_new('Only_Vehicle_Rtn', '', 'create')) {
									?>
									...
									<?php if (has_permission_new('Only_Vehicle_Rtn', '', 'edit')) {
									?>
...
<script>
	...
	$('.saveBtn').on('click',function(){ 
        ...
        if(challan_n !== ''){
            ...
            $.ajax({
                url:"<?php echo admin_url(); ?>VehRtn/SaveOnlyVehRtn",
                dataType:"JSON",
                method:"POST",
                data:{refund_crates:refund_crates,from_date:from_date,challan_n:challan_n,vehicle_number:vehicle_number,Act_datetime:Act_datetime
				},
                beforeSend: function () {
					$('.searchh3').css('display','block');
	...
	$('.updateBtn').on('click',function(){ 
        ...
        if(challan_n !== ''){
            ...
            $.ajax({
                url:"<?php echo admin_url(); ?>VehRtn/UpdateOnlyVehRtn",
                dataType:"JSON",
                method:"POST",
                data:{refund_crates:refund_crates,from_date:from_date,challan_n:challan_n,vehicle_number:vehicle_number,VRtnID:VRtnID,Act_datetime:Act_datetime
				},
                beforeSend: function () {
