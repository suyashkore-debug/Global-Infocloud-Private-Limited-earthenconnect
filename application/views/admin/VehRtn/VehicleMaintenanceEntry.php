					...
					<div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Vehicle Maintenance Entry</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="row">
							...
							<div class="col-md-8">
								<div class="form-group" app-field-wrapper="PartRemark">
									<small class="req text-danger">* </small>
									<label for="PartRemark" class="control-label">Part Repair/Replaced</label>
									<input type="text" id="PartRemark" name="PartRemark" class="form-control" value="">
								</div>
							</div>
							<div class="col-md-2">
							...
							<br>
							<div class="col-md-12">
								<?php if (has_permission_new('VehicleMaintenanceEntry', '', 'create')) {
								?>
								...
								<?php if (has_permission_new('VehicleMaintenanceEntry', '', 'edit')) {
								?>
    ...
    $(document).ready(function(){
		...
		$('#EntryID').blur(function(){ 
			...
			if(EntryID == ''){
				...
				$.ajax({
					url:"<?php echo admin_url(); ?>VehRtn/GetMaintenanceEntryDetailByID",
					dataType:"JSON",
					method:"POST",
					...
					success:function(data){
						...
						if(data == null){
							...
							$("#Driver").selectpicker("refresh");  
							$('#PartRemark').val(data.PartRemark); 
		...
		$('.saveBtn').on('click', function (e) {
			...
			if(EntryID == ""){
				...
				alert("Please Enter Part Repair/Replaced");
				}else if(Amount == ""){
				...
				$.ajax({
					url:"<?php echo admin_url(); ?>VehRtn/SaveMaintenanceEntry",
					dataType:"JSON",
					method:"POST",
					data:{EntryID:EntryID,Amount:Amount,Driver:Driver,Date:Date,PartRemark:PartRemark,VehicleID:VehicleID
					},
					beforeSend: function () {
		...
		$('.updateBtn').on('click',function(){ 
			...
			if(EntryID == ""){
				...
				$.ajax({
					url:"<?php echo admin_url(); ?>VehRtn/UpdateMaintenanceEntry",
					dataType:"JSON",
					method:"POST",
					data:{EntryID:EntryID,Amount:Amount,Driver:Driver,Date:Date,PartRemark:PartRemark,VehicleID:VehicleID
					},
