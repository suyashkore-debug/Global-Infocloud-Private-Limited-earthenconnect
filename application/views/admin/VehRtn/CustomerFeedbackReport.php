					...
					<div class="panel-body">
						...
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Customer Feedback Report</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="_buttons">
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function(){
		...
		function load_data(from_date,to_date,Driver,Customer)
		{
			$.ajax({
				url:"<?php echo admin_url(); ?>VehRtn/LoadCustomerFeedbackReport",
				dataType:"JSON",
				method:"POST",
				data:{from_date:from_date, to_date:to_date,Driver:Driver,Customer:Customer},
				beforeSend: function () {
		...
		$('#search_data').on('click',function(){
			...
			$(".report_for").text(msg);
			load_data(from_date,to_date,Driver,Customer);
	...
	$("#caexcel").click(function(){
		...
		$.ajax({
			url:"<?php echo admin_url(); ?>VehRtn/export_CustomerFeedbackReport",
			method:"POST",
			data:{from_date:from_date, to_date:to_date,Driver:Driver,Customer:Customer},
			beforeSend: function () {
	...
	function RedirectEntry(EntryID){
		$.ajax({
			...
			success:function(data){
				var url = "<?php echo admin_url();?>VehRtn/CustomerFeedback";
...
<script type="text/javascript">
	function printPage(){
		...
		heading_data += '<tr>';
		heading_data += '<td style="text-align:center;"colspan="9">Customer Feedback Report From : '+from_date+' To '+to_date+'</td>';
		heading_data += '</tr>';
