			                ...
			                <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker" name="challan_vehicle" id="challan_vehicle" data-width="100%"  data-action-box="true" data-hide-disabled="true" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
										...
										?>
										<option value="TV" <?php if(!in_array($challan->VehicleType, $vehicle_ids) && $challan->VehicleType == "TV" && isset($challan)){ echo "selected"; }?>>Transport Vehicle</option>
										<option value="SELF" <?php if(!in_array($challan->VehicleType, $vehicle_ids) && $challan->VehicleType == "SELF"  && isset($challan)){ echo "selected"; }?>>SELF</option>
									</select>
								</div>
							</div>
