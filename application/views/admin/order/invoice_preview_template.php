...
<?php
          ...
          //die;
          ?>
<?php echo form_hidden('_attachment_sale_id',$order->OrderID); ?>
      ...
      <div class="panel-body">
               ...
               <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                 ...
                 <!-- <li role="presentation">
                  ...
                  <li role="presentation" class="tab-separator">
                     <a href="#tab_notes" onclick="get_sales_notes(<?php echo $order->OrderID; ?>,'invoices'); return false" aria-controls="tab_notes" role="tab" data-toggle="tab">
         ...
         <div class="row mtop10">
            ...
            <div class="col-md-9 _buttons">
               ...
               <div class="pull-left">
                  ...
                  <?php 
                  //if($invoice_generate){ ?>
                    <!--<a href="<?php echo admin_url('invoices/pdf/'.$order->OrderID.'?output_type=I'); ?>" target="_blank" class="mleft10 pull-right btn btn-success<?php if($invoice->status == Invoices_model::STATUS_PAID || $invoice->status == Invoices_model::STATUS_CANCELLED){echo ' disabled';} ?>">
                     <i class="fa fa-eye"></i> Invoice </a>  -->
                 <?php //}else {
                    //if(has_permission('orders','','create')){ ?>
                    <!--<a href="#" onclick="crate_invoice(<?php echo $order->OrderID; ?>); return false;"  class="mleft10 pull-right btn btn-success<?php if($invoice->status == Invoices_model::STATUS_PAID || $invoice->status == Invoices_model::STATUS_CANCELLED){echo ' disabled';} ?>">
                     <i class="fa fa-plus-square"></i> Create Invoice </a>-->
                     <?php
                    //}
                   //} ?>
                   ...
                   <?php 
                       ...
                       ?>
                       <a href="<?php echo admin_url('challan/list_challan/'.$order->ChallanID); ?>"   class="mleft10 pull-right btn btn-success<?php if($invoice->status == Invoices_model::STATUS_PAID || $invoice->status == Invoices_model::STATUS_CANCELLED){echo ' disabled';} ?>">
         ...
         <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tab_invoice">
               ...
               <?php } ?>
               <?php $this->load->view('admin/order/invoice_preview_html'); ?>
            </div>
            <?php if(count($invoice->payments) > 0) { ?>
