			...
			<div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="row">
						...
						<input type="hidden" class="form-control" name="ship_to_act_gst" id="ship_to_act_gst" value="<?php echo $order->Gstin2; ?>" >
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="billing_state" id="billing_state" value="<?php echo $client_detail->state_name?>" disabled>
							</div>
						</div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="billing_city" class="control-lable">Billing City</label>
                                <input type="text" class="form-control" name="billing_city" id="billing_city" value="<?php echo $order->client->city_name; ?>" disabled>
							</div>
						</div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="ShipToParty" id="ShipToParty" class="selectpicker form-control" data-none-selected-text="None selected" data-live-search="true">
    								...
    								<?php
										...
										?>
    								    <option value="<?php echo $val["AccountID"];?>" <?php if($order->AccountID2 == $val["AccountID"]) { echo "selected";}?>><?php echo $val["company"];?></option>
										<?php
										}
									?>
								</select>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="MaxCrdAmt" id="MaxCrdAmt" value="<?php echo number_format($client_detail->MaxCrdAmt,2); ?>" disabled> 
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="PartyGST" id="PartyGST" value="<?php echo $client_detail->vat; ?>" disabled>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
				...
				<thead>
					<tr>
						...
						<?php
							...
							$qty_heading = _l('order_table_quantity_heading')."(Pkt)";
						...
						<th width="5%" align="left"><?php echo _l('Qty(CS/CR)'); ?></th>
				...
				<tbody>
					<?php
						...
						<tr class="main">
							...
							<td>
								<input type="text" name="rate" id="rate" class="form-control" placeholder="" >
							</td>
							<?php if(isset($order)){
							?>
							<td>
					...
					<?php if (isset($order) || isset($add_items)) {
						...
						foreach ($add_items as $item) {
							...
							$table_row .= '<td class="rate"><input type="number" name="' . $items_indicator . '[' . $i . '][rate1]" value="' . $item['BasicRate'] . '" class="form-control" onblur="calculate_total();" onchange="calculate_total();"> <input type="hidden" name="' . $items_indicator . '[' . $i . '][rate]" value="' . $item['BasicRate'] . '"></td>';
