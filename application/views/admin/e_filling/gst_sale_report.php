					...
					<div class="panel-body">
						...
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>GSTR Sales</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="_buttons">
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function(){
		...
		$('#search_data').on('click',function(){
	        ...
	        $.ajax({
				url:"<?php echo admin_url(); ?>E_filling/load_table",
				dataType:"JSON",
				method:"POST",
				cache: false,
	...
	$("#caexcel").click(function(){
		...
		$.ajax({
            url:"<?php echo admin_url(); ?>E_filling/export_gst_sale_report",
            method:"POST",
            data:{from_date:from_date,account_full_name:account_full_name, to_date:to_date,accountId:accountId,bill_type:bill_type,bill_wise_type:bill_wise_type,gst_type:gst_type},
			beforeSend: function () {
