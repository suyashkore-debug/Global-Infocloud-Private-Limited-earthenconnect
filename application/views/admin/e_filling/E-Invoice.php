					...
					<div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>E-Invoice List</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="Einvoice_report">
                                    <table class="table-striped table-bordered Einvoice_report" id="Einvoice_report" width="100%">
                                    <thead>
                                        <tr class="header">
                                            <th>Sr.No.</th>
                                            <th>Invoice Date</th>
...
<?php init_tail(); ?>
<style>
    .Einvoice_report { overflow: auto;max-height: 60vh;position:relative;top: 0px; }
	.Einvoice_report thead th { position: sticky; top: 0; z-index: 1; }
	.Einvoice_report tbody th { position: sticky; left: 0; }
	
	/* Just common table stuff. Really. */
	.Einvoice_report table  { border-collapse: collapse; }
	.Einvoice_report th, td { padding: 3px 3px !important; white-space: nowrap;font-size:11px; line-height:1.42857143;vertical-align: middle;}
	.Einvoice_report th     { background: #50607b;color: #fff !important; }
...
$(document).ready(function(){
    $('#search_data').on('click',function(){
        ...
        $.ajax({
			url:"<?php echo admin_url(); ?>E_filling/GetEInvoiceReport",
			dataType:"JSON",
			method:"POST",
			cache: false,
	...
	$("#caexcel").click(function(){
		...
		var to_date = $("#to_date").val();
		$.ajax({
            url:"<?php echo admin_url(); ?>E_filling/ExportEInvoiceReport",
            method:"POST",
            data:{from_date:from_date, to_date:to_date},
			beforeSend: function () {
