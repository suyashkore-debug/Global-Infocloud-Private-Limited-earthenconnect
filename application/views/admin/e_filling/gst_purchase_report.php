					...
					<div class="panel-body">
						<nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>GSTR Purchase</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
						<div class="_buttons">
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label for="act_name">Supplier Name</label>
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group">
										<label for="estimate"></label>
										<select name="bill_wise_type" id="bill_wise_type" class="form-control">
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function(){
		...
		$( "#act_name" ).autocomplete({
			...
			source: function( request, response ) {
				...
				$.ajax({
					url: "<?=base_url()?>admin/E_filling/accountlist",
					type: 'post',
					dataType: "json",
					data: {
						search: request.term
		...
		$('#act_name').on('blur', function () {
			...
			$.ajax({
				url: "<?=base_url()?>admin/E_filling/get_Account_Details",
				type: 'post',
				dataType: "json",
				data: {
					AccountID: AccountID,
		...
		$('#search_data').on('click',function(){
	        ...
	        $.ajax({
				url:"<?php echo admin_url(); ?>E_filling/purchase_gst_table",
				dataType:"JSON",
				method:"POST",
				cache: false,
	...
	$("#caexcel").click(function(){
		...
		$.ajax({
            url:"<?php echo admin_url(); ?>E_filling/export_gst_purchase_report",
            method:"POST",
            data:{from_date:from_date,account_full_name:account_full_name, to_date:to_date,accountId:accountId,bill_type:bill_type,bill_wise_type:bill_wise_type,gst_type:gst_type},
			beforeSend: function () {
...
<script>
	$(document).ready(function(){
		...
		$(document).on("click", ".sortable", function () {
			var table = $("#production_report tbody");
