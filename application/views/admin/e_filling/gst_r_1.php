			...
			<div class="col-md-12">
				<div class="panel_s">
					<div class="panel-body">
						<h4 class="no-margin font-bold"><b>GSTR 1 Report</b></h4>
						<div class="_buttons">
											...
											<table class="table table-striped table-bordered B2CL_tbl" id="B2CL_tbl" width="100%">
												<thead>
													<tr>
														...
														<th class="sortable3" class="sortable3">Rate</th>
											...
											<table class="table table-striped table-bordered CDNR_tbl" id="CDNR_tbl" width="100%">
												<thead>
													<tr>
														...
														<th class="sortable5">GSTINUIN o Recipient</th>
											...
											<table class="table table-striped table-bordered CDNUR_tbl" id="CDNUR_tbl" width="100%">
												<thead>
													<tr>
														...
														<th class="sortable6">GSTINUI Nof Recipient</th>
														...
														<th class="sortable6">Reason For Issuing dicument</th>
