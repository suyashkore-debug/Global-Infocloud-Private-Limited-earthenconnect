...
$config['sess_expiration']         = (defined('APP_SESSION_EXPIRATION') ? APP_SESSION_EXPIRATION : 30000);
...
$config['csrf_exclude_uris'] = ['forms/wtl/[0-9a-z]+', 'forms/ticket', 'api\/.+', 'UserApp_Controller/loginAPI'];
...
if ($config['csrf_protection'] == true
    ...
    && strpos($_SERVER['REQUEST_URI'], 'gateways/') !== false  && strpos($_SERVER['REQUEST_URI'], 'UserApp_Controller/') !== false) 
   {
    $config['csrf_protection'] = false;
}
