<?php
	...
	class Accounts_master extends AdminController
	{
		...
		public function ActMainGroup()
		{
			...
			$data['NextAccountGroupID'] = $this->accounts_master_model->GetNextAccountMainGroupID();
		...
		public function get_account_Maingroup_details()
		{
			...
			$account_data = $this->accounts_master_model->get_account_Maingroup_details($accountID);
		...
		{
		    if (!has_permission_new('account_main_groups', '', 'create')) {
				access_denied('Invoice Items');
			}
			$NextAccountGroupID = $this->accounts_master_model->GetNextAccountSunGroupID();
			$data = array(
			'ActGroupID'=>$NextAccountGroupID,
		...
		{
		    if (!has_permission_new('account_main_groups', '', 'edit')) {
				access_denied('Invoice Items');
			}
			$data = array(
			'ActGroupName'=>$this->input->post('ActGroupName'),
		...
		public function SubGroup1()
		{
			...
			$data['AccountSubGroupID1'] = $this->accounts_master_model->GetAccountSubGroupID1_List();
			$data['NextAccountGroupID1'] = $this->accounts_master_model->GetNextAccountSunGroupID1();
			$data['company_detail'] = $this->accounts_master_model->get_company_detail();
		...
		public function SubGroup2()
		{
			...
			$data['NextAccountGroupID2'] = $this->accounts_master_model->GetNextAccountSunGroupID2();
		...
		public function SaveSubGroup1()
		{
			...
			$data = array(
			'SubActGroupID1'=>$this->input->post('SubGroupID'),
		...
		public function UpdateSubGroup1()
		{
			...
			$itemGroupID                     = $this->accounts_master_model->UpdateSubGroup1($data,$SubGroupID);
		...
		public function SaveSubGroup2()
		{
			...
			'SubActGroupID'=>$this->input->post('SubGroupID'),
			'SubActGroupName'=>$this->input->post('SubGroupName'),
			'SubActGroupID1'=>$this->input->post('MainGroupID'),
			);
		...
		public function get_account_subgroup_details1()
		{
			...
			$account_data = $this->accounts_master_model->get_account_subgroup_details1($account_subgroupID);
			echo json_encode($account_data);
		}
