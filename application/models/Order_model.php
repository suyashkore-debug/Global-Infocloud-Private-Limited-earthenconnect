...
//======================== Update Order ========================================
	...
	{	
		...
		foreach ($exiteditems as $exkey => $exvalue) 
		{
			$Salerate =  ($exvalue["rate1"] + ($exvalue["rate1"] * ($exvalue["taxrate1"] /100)));
			$exSaleAmt =  $exvalue["qty"] * $exvalue["rate1"]; // $exvalue["pack_qty"] * Add if Needed
			...
			$exsalerate = $exvalue["rate1"] * ($exvalue["taxrate1"] /100);
