...
class Enquiry_model extends App_Model
{
    ...
    public function get()
    {
        ...
        return $this->db->get(db_prefix() . 'so_enquiry')->result_array();
    }
    /**
    ...
    public function getallstate()
    {
       ...
       $this->db->where('country_id', '101');
        return $this->db->get(db_prefix() . 'xx_states')->result_array();
    }
    ...
    public function get_itemDivision()
    {
        ...
        return $this->db->get(db_prefix() . 'itemdivision')->result_array();
    }
    ...
    public function delete($id)
    {
        ...
        $this->db->where('id', $id);
        $this->db->delete(db_prefix() . 'so_enquiry');
