...
function get_dashboard_widgets()
{
    $widgets = [
        ...
        [
            'path'      => 'admin/dashboard/widgets/ProductionVsSales',
            'container' => 'left-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/TradePayableReport',
            'container' => 'left-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/PurchaseVsSales',
            'container' => 'right-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/top_five_skus',
            'container' => 'left-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/TopFivePurchaseItems',
            'container' => 'right-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/TopFivePurchaseItemsPM',
            'container' => 'right-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/top_five_customers',
            'container' => 'left-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/TopFiveVendorChart',
            'container' => 'right-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/totalMonthlySale',
            'container' => 'left-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/totalMonthlyPurchase',
            'container' => 'right-6',
        ],
        
        [
            'path'      => 'admin/dashboard/widgets/staff_chart_by_job_positions',
            'container' => 'left-6',
        ],
        [
            'path'      => 'admin/dashboard/widgets/staff_departments_chart',
            'container' => 'right-6',
        ],
        // [
