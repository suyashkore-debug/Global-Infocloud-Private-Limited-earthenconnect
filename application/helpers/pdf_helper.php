...
function deliverynote_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/DeliveryNote_pdf', $invoice, $tag);
}

/**
 * Prepare general Route Memo pdf
 * @param  object $invoice Invoice as object with all necessary fields
 * @param  string $tag     tag for bulk pdf exporter
 * @return mixed object
 */
function RouteMemo_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/RouteMemo_pdf', $invoice, $tag);
}

/**
 * Prepare general Dispatch pdf
 * @param  object $invoice Invoice as object with all necessary fields
 * @param  string $tag     tag for bulk pdf exporter
 * @return mixed object
 */
function dispatch_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/dispatch_pdf', $invoice, $tag);
}

/**
 * Prepare general Gate Pass pdf
 * @param  object $invoice Invoice as object with all necessary fields
 * @param  string $tag     tag for bulk pdf exporter
 * @return mixed object
 */
function gatepass_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/gatepass_pdf', $invoice, $tag);
}
/**
...
function PO_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/PO_pdf', $invoice, $tag);
}
function PO_Entry_pdf($invoice, $tag = '')
{
    return app_pdf('invoice', LIBSPATH . 'pdf/PO_Entry_pdf', $invoice, $tag);
}


/**
 * Prepare StorageAuditLog pdf
 * @param  object $statement statement
 * @return mixed
 */
function StorageAuditLog_pdf($statement)
{
