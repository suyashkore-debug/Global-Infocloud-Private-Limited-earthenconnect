<?php
	...
	function app_init_admin_sidebar_menu_items()
	{
		...
		if (has_permission_new('qcparameter_master', '', 'view')) {
			$CI->app_menu->add_sidebar_children_item('master', [
			'slug'     => 'qcparameter_master',
			'name'     => 'Qc Parameter Master',
			'href'     => admin_url('Traceability/QcParameterMaster'),
			'position' => 20,
			]);
		}
		...
		$CI->app_menu->add_sidebar_menu_item('PCP', [
		'collapse' => true,
		'name'     => "PCP",
		'position' => 2,
		'icon'     => 'fa fa-balance-scale',
        ...
        if (has_permission_new('StorageAuditLog', '', 'view')) {
			$CI->app_menu->add_sidebar_children_item('PCP', [
			'slug'     => 'StorageAuditLog',
			'name'     => 'Daily Storage Monitoring Log',
			'href'     => admin_url('StorageAuditLog'),
			'position' => 1,
			]);
		}
		if (has_permission_new('InspectionChecklist', '', 'view')) {
			$CI->app_menu->add_sidebar_children_item('PCP', [
			'slug'     => 'InspectionChecklist',
			'name'     => 'Receiving Inspection Checklist',
			'href'     => admin_url('StorageAuditLog/InspectionChecklist'),
			'position' => 2,
			]);
		}
		if (has_permission_new('SanitationChecklist', '', 'view')) {
			$CI->app_menu->add_sidebar_children_item('PCP', [
			'slug'     => 'SanitationChecklist',
			'name'     => 'Weekly Sanitation Checklist',
			'href'     => admin_url('StorageAuditLog/SanitationChecklist'),
			'position' => 3,
			]);
		}
		if (has_permission_new('PestControlLog', '', 'view')) {
			$CI->app_menu->add_sidebar_children_item('PCP', [
			'slug'     => 'PestControlLog',
			'name'     => 'Weekly/Monthly Pest Control Log',
			'href'     => admin_url('StorageAuditLog/PestControlLog'),
			'position' => 4,
			]);
		}
		...
		if (has_permission_new('TraceabilityLog', '', 'view')) {
			$CI->app_menu->add_sidebar_children_item('PCP', [
			'slug'     => 'TraceabilityLog',
			'name'     => 'Inventory / Traceability Log',
			'href'     => admin_url('StorageAuditLog/TraceabilityLog'),
			'position' => 5,
			]);
		}
		if (has_permission_new('NonConformanceActionLog', '', 'view')) {
			$CI->app_menu->add_sidebar_children_item('PCP', [
			'slug'     => 'NonConformanceActionLog',
			'name'     => 'Non-Conformance & Corrective Action Log',
			'href'     => admin_url('StorageAuditLog/NonConformanceActionLog'),
			'position' => 6,
			]);
		}
		if (has_permission_new('MonthlyInspectionChecklist', '', 'view')) {
			$CI->app_menu->add_sidebar_children_item('PCP', [
			'slug'     => 'MonthlyInspectionChecklist',
			'name'     => 'Monthly Inspection Checklist',
			'href'     => admin_url('StorageAuditLog/MonthlyInspectionChecklist'),
			'position' => 7,
			]);
		}
		if (has_permission_new('RecallMockDrill', '', 'view')) {
			$CI->app_menu->add_sidebar_children_item('PCP', [
			'slug'     => 'RecallMockDrill',
			'name'     => 'Recall Mock Drill',
			'href'     => admin_url('StorageAuditLog/RecallMockDrill'),
			'position' => 8,
			]);
		}
		...
		if (has_permission_new('TransportDashboard', '', 'view')) {
			...
			'slug'     => 'TransportDashboard',
			'name'     => 'Transport Dashboard',
			'href'     => admin_url('VehRtn/TransportDashboard'),
			'position' => 1,
			]);
		}
		...
		if (has_permission_new('Source_details', '', 'view')) {
			...
			'slug'     => 'Source_details',
			'name'     => 'Traceability',
			'href'     => admin_url('Traceability/AddEditProductSrcDetails'),
			'position' => 10,
			]);
		}
        ...
        if (has_permission_new('qc_parameter', '', 'view')) {
			...
			'slug'     => 'qc-parameter',
			'name'     => 'QC Parameter',
			'href'     => admin_url('purchase/QC_Parameter'),
			'position' => 2,
			]);
		}
		...
		// 'slug'     => 'Item_QC',
		// 'name'     => 'Item Wise QC',
		// 'href'     => admin_url('purchase/Item_QC'),
		// 'position' => 5,
		// ]);
		// }
		...
		*/
		...
		if (has_permission_new('manage_leads', '', 'view')) {
