...
class Dispatch_pdf extends App_pdf
{
    protected $invoice;
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_dispatchpdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/dispatchpdf.php';
