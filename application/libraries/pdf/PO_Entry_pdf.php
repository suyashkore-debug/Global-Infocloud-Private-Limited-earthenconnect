...
class PO_Entry_pdf extends App_pdf
{
    protected $invoice;
    ...
    public function __construct($invoice, $tag = '')
    {
        ...
        $this->SetTitle('Purchase Order Print');
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/POEntrypdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/POEntrypdf.php';
