...
class Gatepass_pdf extends App_pdf
{
    protected $invoice;
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_gatepasspdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/gatepasspdf.php';
