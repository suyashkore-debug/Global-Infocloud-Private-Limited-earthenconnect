...
class DeliveryNote_pdf extends App_pdf
{
    protected $invoice;
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/DeliveryNote_pdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/DeliveryNote_pdf.php';
