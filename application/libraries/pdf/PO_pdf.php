...
class PO_pdf extends App_pdf
{
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/POpdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/POpdf.php';
